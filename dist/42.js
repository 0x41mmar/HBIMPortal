...
exports.default = 'Viewing.Extension.ShaderMaterial2';
...
var ShaderMaterialPanel = function (_ToolPanelBase) {
  (0, _inherits3.default)(ShaderMaterialPanel, _ToolPanelBase);

  function ShaderMaterialPanel(container, btnElement) {
    (0, _classCallCheck3.default)(this, ShaderMaterialPanel);

    var _this = (0, _possibleConstructorReturn3.default)(this, (ShaderMaterialPanel.__proto__ || (0, _getPrototypeOf2.default)(ShaderMaterialPanel)).call(this, container, 'Shader Material', {
      buttonElement: btnElement,
      movable: true,
      shadow: true
    }));

    $(_this.container).addClass('shader-material');
    return _this;
  }
  ...
  (0, _createClass3.default)(ShaderMaterialPanel, [{
    key: 'htmlContent',
    value: function htmlContent(id) {
...
exports.default = ShaderMaterialPanel;

/* REACT HOT LOADER */ }).call(this); } finally { if (true) { (function () { var foundReactClasses = module.hot.data && module.hot.data.foundReactClasses || false; if (module.exports && module.makeHot) { var makeExportsHot = __webpack_require__(13); if (makeExportsHot(module, __webpack_require__(0))) { foundReactClasses = true; } var shouldAcceptModule = true && foundReactClasses; if (shouldAcceptModule) { module.hot.accept(function (err) { if (err) { console.error("Cannot apply hot update to " + "Viewing.Extension.ShaderMaterial.Panel.js" + ": " + err.message); } }); } } module.hot.dispose(function (data) { data.makeHot = module.makeHot; data.foundReactClasses = foundReactClasses; }); })(); } }
/* WEBPACK VAR INJECTION */}.call(exports, __webpack_require__(9)(module), __webpack_require__(31)))
...
var _ViewingExtensionShaderMaterial = __webpack_require__(1747);

var _ViewingExtensionShaderMaterial2 = _interopRequireDefault(_ViewingExtensionShaderMaterial);
...
var ShaderMaterialExtension2 = function (_ExtensionBase) {
  (0, _inherits3.default)(ShaderMaterialExtension2, _ExtensionBase);

  /////////////////////////////////////////////////////////////////
  // Class constructor
  //
  /////////////////////////////////////////////////////////////////
  function ShaderMaterialExtension2(viewer, options) {
    (0, _classCallCheck3.default)(this, ShaderMaterialExtension2);
    return (0, _possibleConstructorReturn3.default)(this, (ShaderMaterialExtension2.__proto__ || (0, _getPrototypeOf2.default)(ShaderMaterialExtension2)).call(this, viewer, options));
  }
  ...
  (0, _createClass3.default)(ShaderMaterialExtension2, [{
    key: 'load',
    ...
    value: function load() {
      ...
      this.viewer.addEventListener(Autodesk.Viewing.AGGREGATE_SELECTION_CHANGED_EVENT, this.selectionHandler);

      var shader = THREE.ShaderLib.lambert;

      this.material = this.createShaderMaterial((0, _assign2.default)({}, shader, {
    ...
    value: function createShaderMaterial(data) {

      var material = new THREE.ShaderMaterial(data);

      this._viewer.impl.matman().addMaterial(data.name, material, true);
    ...
    value: function () {
      var _ref = (0, _asyncToGenerator3.default)( /*#__PURE__*/_regenerator2.default.mark(function _callee(event) {
        var selection, dbId, fragIds, fragList;
        return _regenerator2.default.wrap(function _callee$(_context) {
          while (1) {
            switch (_context.prev = _context.next) {
              case 0:
                ...
                _context.next = 5;
                return _Viewer4.default.getFragIds(this._viewer.model, dbId);

              case 5:
                fragIds = _context.sent;
                fragList = this._viewer.model.getFragmentList();
    ...
    key: 'setMaterial',
    value: function setMaterial(fragIds, material) {

      var fragList = this._viewer.model.getFragmentList();

      this.toArray(fragIds).forEach(function (fragId) {
  ...
  return ShaderMaterialExtension2;
}(_Viewer2.default); /////////////////////////////////////////////////////////////////
...
Autodesk.Viewing.theExtensionManager.registerExtension(ShaderMaterialExtension2.ExtensionId, ShaderMaterialExtension2);

/* REACT HOT LOADER */ }).call(this); } finally { if (true) { (function () { var foundReactClasses = module.hot.data && module.hot.data.foundReactClasses || false; if (module.exports && module.makeHot) { var makeExportsHot = __webpack_require__(13); if (makeExportsHot(module, __webpack_require__(0))) { foundReactClasses = true; } var shouldAcceptModule = true && foundReactClasses; if (shouldAcceptModule) { module.hot.accept(function (err) { if (err) { console.error("Cannot apply hot update to " + "Viewing.Extension.ShaderMaterial.js" + ": " + err.message); } }); } } module.hot.dispose(function (data) { data.makeHot = module.makeHot; data.foundReactClasses = foundReactClasses; }); })(); } }
/* WEBPACK VAR INJECTION */}.call(exports, __webpack_require__(9)(module)))
...
if(true) {
	// When the styles change, update the <style> tags
	if(!content.locals) {
		module.hot.accept(1409, function() {
			var newContent = __webpack_require__(1409);
			if(typeof newContent === 'string') newContent = [[module.i, newContent, '']];
			update(newContent);
		});
	}
