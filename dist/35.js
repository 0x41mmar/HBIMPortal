...
// module
exports.push([module.i, ".bar-chart .title {\n  position: relative !important;\n  overflow: visible;\n  float: left; }\n\n.bar-chart .title > label {\n  white-space: nowrap;\n  font-weight: normal;\n  -webkit-user-select: none;\n     -moz-user-select: none;\n      -ms-user-select: none;\n          user-select: none;\n  margin-left: 27px;\n  select: none;\n  width: 85px; }\n\n.bar-chart .title > .dropdown {\n  position: relative;\n  top: -1px; }\n\n.bar-chart .title > button {\n  margin-left: 4px;\n  height: 26px; }\n\n.bar-chart .title > .dropdown > button {\n  padding: 2px 12px;\n  height: 26px; }\n\n.bar-chart .title .dropdown-menu {\n  overflow: scroll; }\n\n.bar-chart .loader-background {\n  background: #fdfdfd; }\n\n.bar-chart .loader, .bar-chart .loader:before, .bar-chart .loader:after {\n  top: 35%; }\n\n.bar-chart .loader:before, .bar-chart .loader:after {\n  margin: -9px auto; }\n", ""]);
...
exports.default = 'Viewing.Extension.BarChart';
...
var BarChartExtension = function (_MultiModelExtensionB) {
  (0, _inherits3.default)(BarChartExtension, _MultiModelExtensionB);

  /////////////////////////////////////////////////////////
  // Class constructor
  //
  /////////////////////////////////////////////////////////
  function BarChartExtension(viewer, options) {
    (0, _classCallCheck3.default)(this, BarChartExtension);

    var _this = (0, _possibleConstructorReturn3.default)(this, (BarChartExtension.__proto__ || (0, _getPrototypeOf2.default)(BarChartExtension)).call(this, viewer, options));

    _this.toggleTheming = _this.toggleTheming.bind(_this);
  ...
  (0, _createClass3.default)(BarChartExtension, [{
    key: 'load',
    ...
    value: function unload() {
      ...
      (0, _get3.default)(BarChartExtension.prototype.__proto__ || (0, _getPrototypeOf2.default)(BarChartExtension.prototype), 'unload', this).call(this);
    ...
    value: function () {
      var _ref = (0, _asyncToGenerator3.default)( /*#__PURE__*/_regenerator2.default.mark(function _callee(model) {
        ...
        var chartProperties, fragIds, fragList;
        return _regenerator2.default.wrap(function _callee$(_context) {
          while (1) {
            switch (_context.prev = _context.next) {
              case 0:
              ...
              case 4:
                ...
                _context.t0 = this.options.chartProperties;
              ...
              case 10:
                chartProperties = _context.t0;


                $('#bar-chart-dropdown').parent().find('ul').css({
                  height: Math.min($('.bar-chart').height() - 42, chartProperties.length * 26 + 16)
                });
              ...
              case 14:
                ...
                this.setActiveProperty(chartProperties[this.options.defaultIndex || 0]);

                _context.next = 17;
                return _Viewer6.default.getFragIds(model, this.componentIds);
              ...
              case 17:
                ...
                fragIds.forEach(function (fragId) {
                  ...
                  if (material) {
                    ...
                    _this3.fragIdToMaterial[fragId] = material;
                  }
                });
    ...
    key: 'toggleTheming',
    value: function toggleTheming() {
      var _this4 = this;

      var state = this.react.getState();

      var theming = !state.theming;
      ...
      if (theming) {
        ...
        state.data.forEach(function (group) {
          ...
          group.dbIds.forEach(function (dbId) {

            var model = _this4.viewer.activeModel || _this4.viewer.model;

            _Viewer6.default.setMaterial(model, dbId, group.material);
          });
        });
      } else {

        for (var fragId in this.fragIdToMaterial) {

          var material = this.fragIdToMaterial[fragId];

          var model = this.viewer.activeModel || this.viewer.model;
        ...
        return _regenerator2.default.wrap(function _callee2$(_context2) {
          while (1) {
            switch (_context2.prev = _context2.next) {
              ...
              case 3:
                _context2.next = 5;
                return this.buildPropertyData(propName);
                ...
                if (state.theming) {
                  ...
                  data.forEach(function (group) {
                    ...
                    group.dbIds.forEach(function (dbId) {
                      ...
                      var model = _this5.viewer.activeModel || _this5.viewer.model;
    ...
    value: function () {
      var _ref3 = (0, _asyncToGenerator3.default)( /*#__PURE__*/_regenerator2.default.mark(function _callee3(propName) {
        var _this6 = this;

        var model, componentsMap, key, groupedMap, keys, colors, data;
        return _regenerator2.default.wrap(function _callee3$(_context3) {
          while (1) {
            switch (_context3.prev = _context3.next) {
              case 0:
                model = this.viewer.activeModel || this.viewer.model;
                _context3.next = 3;
                return _Viewer6.default.mapComponentsByProp(model, propName, this.componentIds);

              case 3:
                componentsMap = _context3.sent;
                ...
                data = keys.map(function (key, idx) {

                  var dbIds = groupedMap[key];

                  var color = colors(idx);

                  var percent = 100 * dbIds.length / _this6.componentIds.length;

                  return {
                    label: key + ': ' + percent.toFixed(2) + '% (' + dbIds.length + ')',
                    material: _this6.createMaterial(color),
                    value: dbIds.length,
                    shortLabel: key,
                    percent: percent,
                    dbIds: dbIds,
      ...
      function buildPropertyData(_x4) {
        return _ref3.apply(this, arguments);
      }
    ...
    value: function onStopResize() {
      ...
      $('#bar-chart-dropdown').parent().find('ul').css({
        height: Math.min($('.bar-chart').height() - 42, state.items.length * 26 + 16)
      });
    ...
    value: function renderTitle() {
      ...
      var menuItems = state.items.map(function (item, idx) {
        return _react2.default.createElement(
          ...
          { eventKey: idx, key: idx, onClick: function onClick() {
              ...
              _this7.setActiveProperty(item, true);
            } },
          item
        );
      });
      ...
      var themingClr = {
        color: state.theming ? '#FF0000' : '#9b9b9b'
      };
      ...
      return _react2.default.createElement(
        ...
        _react2.default.createElement(
          ...
          { onClick: this.toggleTheming,
            disabled: state.disabled,
            title: 'color theming' },
          _react2.default.createElement('span', { className: 'fa fa-paint-brush', style: themingClr })
        )
      );
    }
    ...
    value: function render() {
      ...
      return _react2.default.createElement(
        ...
        _react2.default.createElement(_BarChart2.default, { onGroupClicked: function onGroupClicked(e) {
            ...
            var model = _this8.viewer.activeModel || _this8.viewer.model;

            _Viewer6.default.isolateFull(_this8.viewer, dbIds, model);

            _this8.viewer.fitToView();
          },
          guid: state.guid,
          data: state.data
        })
...
Autodesk.Viewing.theExtensionManager.registerExtension(BarChartExtension.ExtensionId, BarChartExtension);

/* REACT HOT LOADER */ }).call(this); } finally { if (true) { (function () { var foundReactClasses = module.hot.data && module.hot.data.foundReactClasses || false; if (module.exports && module.makeHot) { var makeExportsHot = __webpack_require__(13); if (makeExportsHot(module, __webpack_require__(0))) { foundReactClasses = true; } var shouldAcceptModule = true && foundReactClasses; if (shouldAcceptModule) { module.hot.accept(function (err) { if (err) { console.error("Cannot apply hot update to " + "Viewing.Extension.BarChart.js" + ": " + err.message); } }); } } module.hot.dispose(function (data) { data.makeHot = module.makeHot; data.foundReactClasses = foundReactClasses; }); })(); } }
/* WEBPACK VAR INJECTION */}.call(exports, __webpack_require__(9)(module), __webpack_require__(31)))
...
if(true) {
	// When the styles change, update the <style> tags
	if(!content.locals) {
		module.hot.accept(1383, function() {
			var newContent = __webpack_require__(1383);
			if(typeof newContent === 'string') newContent = [[module.i, newContent, '']];
			update(newContent);
		});
	}
