...
/* WEBPACK VAR INJECTION */}.call(exports, __webpack_require__(21), __webpack_require__(9)(module)))
...
exports.default = 'Viewing.Extension.MarqueeSelect';
...
var _lodash = __webpack_require__(1444);
...
var _window = window,
    Autodesk = _window.Autodesk,
    THREE = _window.THREE;
var MarqueeSelect = (_temp = _class = function (_MultiModelExtensionB) {
  (0, _inherits3.default)(MarqueeSelect, _MultiModelExtensionB);

  function MarqueeSelect(viewer, options) {
    (0, _classCallCheck3.default)(this, MarqueeSelect);

    var _this = (0, _possibleConstructorReturn3.default)(this, (MarqueeSelect.__proto__ || (0, _getPrototypeOf2.default)(MarqueeSelect)).call(this, viewer, options));
  ...
  (0, _createClass3.default)(MarqueeSelect, [{
    key: 'init',
    value: function init() {
    ...
    value: function () {
      var _ref = (0, _asyncToGenerator3.default)( /*#__PURE__*/_regenerator2.default.mark(function _callee() {
        var mappings, ids, isolateDbIds, hiddenDbIds, isolatedToShowDbIds, toShowIds;
        return _regenerator2.default.wrap(function _callee$(_context) {
          while (1) {
            switch (_context.prev = _context.next) {
              case 0:
                _context.next = 2;
                return this.getExternalIdMapping();

              case 2:
                mappings = _context.sent;
                ids = [];
                isolateDbIds = this.viewer.getIsolatedNodes();
                hiddenDbIds = this.viewer.getHiddenNodes();
                ...
                return _context.abrupt('return', (0, _values2.default)(mappings));

              case 8:
                // TODO: caculate the shown dbIds
                if (isolateDbIds.length > 0) {
                  isolatedToShowDbIds = this.getIdsByExternalId(mappings, isolateDbIds, true);

                  ids = isolatedToShowDbIds;
                } else {
                  toShowIds = this.getIdsByExternalId(mappings, hiddenDbIds, false);
    ...
    key: 'getIdsByExternalId',
    value: function getIdsByExternalId(mappings, dbIds, isExclude) {
      var ids = [];
      ...
      if (dbIds[0] === rootId && isExclude) {
        return (0, _values2.default)(mappings);
      }

      var mapping = (0, _lodash.clone)(mappings);
      dbIds.forEach(function (id) {
        var extId = (0, _lodash.findKey)(mapping, function (dbId) {
          return id === dbId;
        });
        (0, _lodash.forOwn)(mapping, function (dbId, eId) {
          if (eId.startsWith(extId) === isExclude) {
            mapping = (0, _lodash.omit)(mapping, extId);
            ids.push(dbId);
          }
        });
      });
    ...
    value: function () {
      var _ref2 = (0, _asyncToGenerator3.default)( /*#__PURE__*/_regenerator2.default.mark(function _callee2(event) {
        var viewer, canvas, cRect, pos, vector;
          ...
          while (1) {
            switch (_context2.prev = _context2.next) {
              ...
              case 2:
                ...
                vector = new THREE.Vector3(pos.x, pos.y, 1);
    ...
    key: 'calcDbidPP',
    value: function () {
      var _ref3 = (0, _asyncToGenerator3.default)( /*#__PURE__*/_regenerator2.default.mark(function _callee4(defaultShownDbIds) {
        var _this2 = this;
          ...
          while (1) {
            switch (_context4.prev = _context4.next) {
              case 0:
                ...
                defaultShownDbIds.forEach(function () {
                  var _ref4 = (0, _asyncToGenerator3.default)( /*#__PURE__*/_regenerator2.default.mark(function _callee3(dbId) {
                    var bounds, max, min, pivotPoint, pivotPointMin, pivotPointMax;
                    return _regenerator2.default.wrap(function _callee3$(_context3) {
                      while (1) {
                        switch (_context3.prev = _context3.next) {
                          case 0:
                            _context3.next = 2;
                            return _this2.enumNodeFragments(dbId);

                          case 2:
                            bounds = _context3.sent;
                            max = bounds.max, min = bounds.min;
                            pivotPoint = { x: (max.x + min.x) / 2, y: (max.y + min.y) / 2, z: (max.z + min.z) / 2 };
                            pivotPointMin = { x: min.x, y: min.y, z: min.z };
                            pivotPointMax = { x: max.x, y: max.y, z: max.z };
    ...
    value: function () {
      var _ref5 = (0, _asyncToGenerator3.default)( /*#__PURE__*/_regenerator2.default.mark(function _callee5(event) {
        ...
        var viewer, hiddenDbIds, showDbIds, dbIds, dbInBounds, defaultShownDbIds;
          ...
          while (1) {
            switch (_context5.prev = _context5.next) {
              ...
              case 6:
                ...
                hiddenDbIds = this.viewer.getHiddenNodes();
                _context5.next = 10;
                return this.getShowIds();

              case 10:
                showDbIds = _context5.sent;
                _context5.next = 13;
                return this.calcDbidPP(showDbIds);

              case 13:
                dbIds = (0, _lodash.keys)(this.dbIdPP);
                dbInBounds = [];

                dbIds.forEach(function (dbId) {
                  if (+dbId === _this3.viewer.model.getRootId()) {
                    return;
                  }
                  var _dbIdPP$dbId = _this3.dbIdPP[dbId],
                      min = _dbIdPP$dbId.min,
                      max = _dbIdPP$dbId.max;
                  // const isInBounds = this.withinBounds(pivot, this.bounds)

                  var isMaxInBounds = _this3.withinBounds(max, _this3.bounds);
                  var isMinInBounds = _this3.withinBounds(min, _this3.bounds);
                  if (isMaxInBounds && isMinInBounds) {
                    dbInBounds.push(+dbId);
                  }
                });
                defaultShownDbIds = (0, _lodash.difference)(dbInBounds, hiddenDbIds);
...
}(_Viewer2.default), _initialiseProps = function _initialiseProps() {
  var _this4 = this;

  this.lockViewport = function () {
    _this4.viewer.setNavigationLock(true);
  };

  this.unlockViewport = function () {
    _this4.viewer.setNavigationLock(false);
  };
  ...
  this.enumNodeFragments = function (dbId) {
    var viewer = _this4.viewer;
  ...
  this.onMouseMove = function (event) {
    if (!(event.ctrlKey && event.altKey && _this4.mousedown)) {
      return;
    }
    _this4.marquee.show();
    var pos = {};
    pos.x = event.clientX - _this4.mousedowncoords.x;
    pos.y = event.clientY - _this4.mousedowncoords.y;
    if (pos.x < 0 && pos.y < 0) {
      _this4.marquee.css({ left: event.clientX + 'px', width: -pos.x + 'px', top: event.clientY + 'px', height: '' + -pos.y });
    } else if (pos.x >= 0 && pos.y <= 0) {
      _this4.marquee.css({ left: _this4.mousedowncoords.x + 'px', width: pos.x + 'px', top: event.clientY + 'px', height: -pos.y + 'px' });
    } else if (pos.x >= 0 && pos.y >= 0) {
      _this4.marquee.css({ left: _this4.mousedowncoords.x + 'px', width: pos.x + 'px', height: pos.y + 'px', top: _this4.mousedowncoords.y + 'px' });
    } else if (pos.x < 0 && pos.y >= 0) {
      _this4.marquee.css({ left: event.clientX + 'px', width: -pos.x + 'px', height: pos.y + 'px', top: _this4.mousedowncoords.y + 'px' });
    }
    _this4.findCubesByVertices({ x: event.clientX, y: event.clientY });
  };

  this.findCubesByVertices = function (location) {
    var currentMouse = {};
    var mouseInitialDown = {};
    currentMouse.x = location.x - _this4.offset.x;
    currentMouse.y = location.y - _this4.offset.y;
    mouseInitialDown.x = _this4.mousedowncoords.x - _this4.offset.x;
    mouseInitialDown.y = _this4.mousedowncoords.y - _this4.offset.y;
    _this4.findBounds(currentMouse, _this4.mousedowncoords);
  };

  this.findBounds = function (pos1, pos2) {
    var origin = {};
    var delta = {};
    ...
    var bounds = { origin: origin, delta: delta };
    _this4.bounds = bounds;
    window.bounds = bounds;
    return bounds;
  };

  this.withinBounds = function (pos, bounds) {
    var ox = bounds.origin.x;
    var dx = bounds.origin.x + bounds.delta.x;
    var oy = bounds.origin.y;
    var dy = bounds.origin.y + bounds.delta.y;
...
exports.default = MarqueeSelect;


Autodesk.Viewing.theExtensionManager.registerExtension(MarqueeSelect.ExtensionId, MarqueeSelect);

/* REACT HOT LOADER */ }).call(this); } finally { if (true) { (function () { var foundReactClasses = module.hot.data && module.hot.data.foundReactClasses || false; if (module.exports && module.makeHot) { var makeExportsHot = __webpack_require__(13); if (makeExportsHot(module, __webpack_require__(0))) { foundReactClasses = true; } var shouldAcceptModule = true && foundReactClasses; if (shouldAcceptModule) { module.hot.accept(function (err) { if (err) { console.error("Cannot apply hot update to " + "MarqueeSelect.js" + ": " + err.message); } }); } } module.hot.dispose(function (data) { data.makeHot = module.makeHot; data.foundReactClasses = foundReactClasses; }); })(); } }
