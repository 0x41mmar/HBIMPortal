...
// module
exports.push([module.i, ".model-transformer .title {\n  display: -webkit-inline-box;\n  display: -ms-inline-flexbox;\n  display: inline-flex;\n  float: left; }\n\n.model-transformer .title > label {\n  -webkit-user-select: none;\n  -moz-user-select: none;\n  -ms-user-select: none;\n  white-space: nowrap;\n  font-weight: normal;\n  user-select: none;\n  margin-left: 27px;\n  margin-top: 10px;\n  select: none;\n  width: 144px;\n  float: left; }\n\n.model-transformer .content > .controls {\n  margin: 10px 10px 0px 10px;\n  display: inline-block;\n  white-space: nowrap;\n  height: 54px;\n  width: 100%; }\n\n.model-loader .model-transformer .content > .controls {\n  margin: 0px 10px 0px 10px !important; }\n\n.model-transformer .content > .controls > .row {\n  width: 100%;\n  margin: 0; }\n\n.model-transformer .content > .controls > .row > .label-container {\n  margin: 2px 0 0 0;\n  width: 78px; }\n\n.model-transformer .content > .controls button {\n  background: whitesmoke;\n  border-radius: 4px;\n  margin-left: 4px;\n  outline: none;\n  height: 26px;\n  width: 30px;\n  float: left; }\n\n.model-transformer .content > .controls button.active {\n  border: 2px solid #FF9800; }\n\n.model-transformer .content > .controls button.active > span {\n  color: #FF9800; }\n\n.model-transformer .content > .controls button > span {\n  position: relative;\n  font-size: 16px;\n  color: #9b9b9b;\n  top: -1px; }\n\n.model-transformer .content > .controls button:disabled > span {\n  color: #d0d0d0; }\n\n.model-transformer .content > .controls button:hover:not(:disabled) > span {\n  color: #FF9800; }\n\n.model-transformer .content > .controls button:disabled > span {\n  color: #d0d0d0; }\n\n.model-transformer .content > .controls label {\n  margin: 4px 10px 0 0px;\n  font-weight: normal;\n  float: left; }\n\n.model-transformer .input-trans {\n  border: 1px solid #dedede;\n  width: calc(33% - 48px);\n  padding: 2px 0 0 4px;\n  background: #eaeaea;\n  border-radius: 4px;\n  margin: 0 0 6px 5px;\n  overflow: hidden;\n  text-align: left;\n  color: #000000;\n  height: 26px;\n  float: left; }\n\n.model-transformer .input-scale, .model-transformer .input-rot {\n  border: 1px solid #dedede;\n  width: calc(33% - 48px);\n  padding: 2px 0 0 4px;\n  background: #eaeaea;\n  margin: 0 0 6px 5px;\n  border-radius: 4px;\n  overflow: hidden;\n  text-align: left;\n  color: #000000;\n  height: 26px;\n  float: left; }\n\n.model-transformer .switch-container {\n  border: 1px solid #9c9c9c;\n  border-radius: 12px;\n  margin: 6px 0 0 0px;\n  float: left; }\n\n.model-transformer input[type=\"checkbox\"].switch + div {\n  width: 34px;\n  height: 16px; }\n\n.model-transformer input[type=\"checkbox\"].switch:checked + div {\n  width: 34px; }\n\n.model-transformer input[type=\"checkbox\"].switch:checked + div > div {\n  -webkit-transform: translate3d(18px, 0, 0);\n          transform: translate3d(18px, 0, 0); }\n\n.model-transformer input[type=\"checkbox\"].switch + div > div {\n  height: 16px;\n  width: 16px;\n  margin: 0; }\n\n.model-transformer-controls {\n  margin: auto 0 auto calc(100% - 175px);\n  position: relative;\n  float: left; }\n\n.model-transformer-controls > button {\n  border: 1px solid #c6c6c6;\n  background-color: #e1e1e1;\n  border-radius: 6px;\n  position: relative;\n  overflow: hidden;\n  outline: none;\n  height: 24px;\n  width: 26px; }\n\n.model-transformer-controls > button:hover {\n  border: 1px solid #878787;\n  background-color: #f5f5f5; }\n\n.model-transformer-controls > button > label {\n  position: relative;\n  font-size: 20px;\n  color: #f0fcff;\n  top: -8px; }\n\n.model-transformer-controls > button > span {\n  pointer-events: none;\n  color: #9b9b9b; }\n\n.pick-tooltip {\n  position: absolute;\n  color: #00e100;\n  display: none; }\n", ""]);
...
exports.default = 'Viewing.Extension.ModelTransformer';
...
var _Viewer7 = __webpack_require__(1260);

var _Viewer8 = _interopRequireDefault(_Viewer7);
...
var ModelTransformerExtension = function (_MultiModelExtensionB) {
  (0, _inherits3.default)(ModelTransformerExtension, _MultiModelExtensionB);
  ...
  function ModelTransformerExtension(viewer, options) {
    (0, _classCallCheck3.default)(this, ModelTransformerExtension);

    var _this = (0, _possibleConstructorReturn3.default)(this, (ModelTransformerExtension.__proto__ || (0, _getPrototypeOf2.default)(ModelTransformerExtension)).call(this, viewer, options));

    _this.onDeactivate = _this.onDeactivate.bind(_this);

    _this.renderTitle = _this.renderTitle.bind(_this);

    _this.onTransform = _this.onTransform.bind(_this);

    _this.onTransformSelection = _this.onTransformSelection.bind(_this);

    _this.tooltip = new _Viewer8.default(viewer, {
      stroke: '#00FF00',
      fill: '#00FF00'
    });
  ...
  (0, _createClass3.default)(ModelTransformerExtension, [{
    key: 'load',
    ...
    value: function load() {
      ...
      var fullTransform = !!this.options.fullTransform;
      ...
      this.viewer.loadDynamicExtension('Viewing.Extension.Transform', {
        hideControls: true
      }).then(function (transformExtension) {

        transformExtension.setFullTransform(fullTransform);

        transformExtension.on('selection', _this2.onTransformSelection);

        transformExtension.on('transform', _this2.onTransform);

        transformExtension.on('deactivate', _this2.onDeactivate);
    ...
    value: function unload() {
      ...
      var _react$getState = this.react.getState(),
          transformExtension = _react$getState.transformExtension;
      ...
      (0, _get3.default)(ModelTransformerExtension.prototype.__proto__ || (0, _getPrototypeOf2.default)(ModelTransformerExtension.prototype), 'unload', this).call(this);
    ...
    value: function setModel(model) {
      var _react$getState2 = this.react.getState(),
          fullTransform = _react$getState2.fullTransform;
      ...
      if (fullTransform) {
        ...
        this.setTransformState(model.transform);
      }
    }
    ...
    key: 'toFixedStr',
    value: function toFixedStr(float) {
    ...
    key: 'setTransformState',
    value: function setTransformState(transform) {
    ...
    key: 'clearTransformState',
    value: function clearTransformState() {
    ...
    value: function () {
      var _ref = (0, _asyncToGenerator3.default)( /*#__PURE__*/_regenerator2.default.mark(function _callee(data) {
        var _react$getState3, fullTransform, pick, transform;

        return _regenerator2.default.wrap(function _callee$(_context) {
          while (1) {
            switch (_context.prev = _context.next) {
              case 0:
                _react$getState3 = this.react.getState(), fullTransform = _react$getState3.fullTransform, pick = _react$getState3.pick;
              ...
              case 5:
                ...
                if (fullTransform) {
                  ...
                  data.model.transform = (0, _assign2.default)(data.model.transform, data.transform);

                  this.setModel(data.model);
                } else {
                  transform = this.getFragmentTransform(data.fragIds[0]);
    ...
    value: function getFragmentTransform(fragId) {
      ...
      var quaternion = new THREE.Quaternion(fragProxy.quaternion._x, fragProxy.quaternion._y, fragProxy.quaternion._z, fragProxy.quaternion._w);
    ...
    value: function onSelection(event) {
      var _react$getState5 = this.react.getState(),
          fullTransform = _react$getState5.fullTransform;

      var selection = event.selections.length ? event.selections[0] : null;
      ...
      if (!fullTransform) {
        ...
        if (selection) {
          ...
          var transform = this.getFragmentTransform(selection.fragIdsArray[0]);
    ...
    key: 'onTransformSelection',
    value: function onTransformSelection(transformSelection) {
    ...
    key: 'onInputChanged',
    value: function () {
      var _ref2 = (0, _asyncToGenerator3.default)( /*#__PURE__*/_regenerator2.default.mark(function _callee2(e, key) {
          ...
          while (1) {
            switch (_context2.prev = _context2.next) {
              case 0:
                ...
                _context2.t0 = key;
                _context2.next = _context2.t0 === 'Tx' ? 7 : _context2.t0 === 'Ty' ? 9 : _context2.t0 === 'Tz' ? 11 : _context2.t0 === 'Rx' ? 13 : _context2.t0 === 'Ry' ? 15 : _context2.t0 === 'Rz' ? 17 : _context2.t0 === 'Sx' ? 19 : _context2.t0 === 'Sy' ? 26 : _context2.t0 === 'Sz' ? 28 : 30;
                break;

              case 7:
                transform.translation.x = this.toFloat(value);
                return _context2.abrupt('break', 30);

              case 9:
                transform.translation.y = this.toFloat(value);
                return _context2.abrupt('break', 30);

              case 11:
                transform.translation.z = this.toFloat(value);
                return _context2.abrupt('break', 30);

              case 13:
                transform.rotation.x = this.toFloat(value) * Math.PI / 180;
                return _context2.abrupt('break', 30);

              case 15:
                transform.rotation.y = this.toFloat(value) * Math.PI / 180;
                return _context2.abrupt('break', 30);

              case 17:
                transform.rotation.z = this.toFloat(value) * Math.PI / 180;
                return _context2.abrupt('break', 30);
              ...
              case 30:
                _context2.next = 32;
                return this.react.setState(state);
      ...
      function onInputChanged(_x3, _x4) {
        return _ref2.apply(this, arguments);
      }
    ...
    value: function getTransform() {
      var _react$getState6 = this.react.getState(),
          fullTransform = _react$getState6.fullTransform,
          model = _react$getState6.model,
          selection = _react$getState6.selection;

      return !fullTransform ? this.getFragmentTransform(selection.fragIdsArray[0]) : model.transform;
    }
    ...
    value: function applyTransform(transform) {
      ...
      var _react$getState7 = this.react.getState(),
          fullTransform = _react$getState7.fullTransform,
          model = _react$getState7.model,
          selection = _react$getState7.selection;

      var euler = new THREE.Euler(transform.rotation.x + offset.rotation.x, transform.rotation.y + offset.rotation.y, transform.rotation.z + offset.rotation.z, 'XYZ');
      ...
      if (fullTransform) {
        ...
        for (var fragId = 0; fragId < fragCount; ++fragId) {
          ...
          this.transformFragProxy(model, fragId, fragTransform);
        }
      } else {

        selection.fragIdsArray.forEach(function (fragId) {

          _this3.transformFragProxy(model, fragId, fragTransform);
        });
      }
    }
    ...
    key: 'transformFragProxy',
    value: function transformFragProxy(model, fragId, transform) {
    ...
    value: function translate() {
      var _react$getState8 = this.react.getState(),
          transformExtension = _react$getState8.transformExtension,
          translate = _react$getState8.translate;

      translate ? transformExtension.deactivate() : transformExtension.translate();
    ...
    value: function rotate() {
      var _react$getState9 = this.react.getState(),
          transformExtension = _react$getState9.transformExtension,
          rotate = _react$getState9.rotate;

      rotate ? transformExtension.deactivate() : transformExtension.rotate();
    ...
    value: function pickPosition() {
      var _react$getState10 = this.react.getState(),
          transformExtension = _react$getState10.transformExtension;
      ...
      var _ref3 = (0, _asyncToGenerator3.default)( /*#__PURE__*/_regenerator2.default.mark(function _callee3(docked) {
        ...
        return _regenerator2.default.wrap(function _callee3$(_context3) {
          while (1) {
            switch (_context3.prev = _context3.next) {
              case 0:
                id = ModelTransformerExtension.ExtensionId;
    ...
    key: 'onFullModelTransformChecked',
    value: function onFullModelTransformChecked(fullTransform) {
      var _react$getState11 = this.react.getState(),
          transformExtension = _react$getState11.transformExtension;
    ...
    value: function renderTitle(docked) {
      ...
      return _react2.default.createElement(
        ...
        _react2.default.createElement(
          'div',
          { className: 'model-transformer-controls' },
          _react2.default.createElement(
            'button',
    ...
    value: function renderControls() {
      ...
      var disabled = state.fullTransform ? !model : !selection;

      var pickDisabled = !selection || !state.translate || !state.transformSelection || state.transformSelection.type !== 'translate';
      ...
      return _react2.default.createElement(
        ...
        _react2.default.createElement(
          'div',
          { className: 'row' },
          _react2.default.createElement(_Label2.default, { text: 'Translation:' }),
          _react2.default.createElement(_reactContenteditable2.default, {
            onChange: function onChange(e) {
              return _this5.onInputChanged(e, 'Tx');
            },
            onKeyDown: function onKeyDown(e) {
              return _this5.onKeyDownNumeric(e);
            },
          ...
          _react2.default.createElement(_reactContenteditable2.default, {
            onChange: function onChange(e) {
              return _this5.onInputChanged(e, 'Ty');
            },
            onKeyDown: function onKeyDown(e) {
              return _this5.onKeyDownNumeric(e);
            },
          ...
          _react2.default.createElement(_reactContenteditable2.default, {
            onChange: function onChange(e) {
              return _this5.onInputChanged(e, 'Tz');
            },
            onKeyDown: function onKeyDown(e) {
              return _this5.onKeyDownNumeric(e);
            },
        ...
        _react2.default.createElement(
          'div',
          { className: 'row' },
          _react2.default.createElement(_Label2.default, { text: 'Rotation:' }),
          _react2.default.createElement(_reactContenteditable2.default, {
            onChange: function onChange(e) {
              return _this5.onInputChanged(e, 'Rx');
            },
            onKeyDown: function onKeyDown(e) {
              return _this5.onKeyDownNumeric(e);
            },
          ...
          _react2.default.createElement(_reactContenteditable2.default, {
            onChange: function onChange(e) {
              return _this5.onInputChanged(e, 'Ry');
            },
            onKeyDown: function onKeyDown(e) {
              return _this5.onKeyDownNumeric(e);
            },
          ...
          _react2.default.createElement(_reactContenteditable2.default, {
            onChange: function onChange(e) {
              return _this5.onInputChanged(e, 'Rz');
            },
            onKeyDown: function onKeyDown(e) {
              return _this5.onKeyDownNumeric(e);
            },
        ...
        _react2.default.createElement(
          'div',
          { className: 'row' },
          _react2.default.createElement(_Label2.default, { text: 'Scale:' }),
          _react2.default.createElement(_reactContenteditable2.default, {
            onChange: function onChange(e) {
              return _this5.onInputChanged(e, 'Sx');
            },
            onKeyDown: function onKeyDown(e) {
              return _this5.onKeyDownNumeric(e);
            },
          ...
          _react2.default.createElement(_reactContenteditable2.default, {
            onChange: function onChange(e) {
              return _this5.onInputChanged(e, 'Sy');
            },
            onKeyDown: function onKeyDown(e) {
              return _this5.onKeyDownNumeric(e);
            },
          ...
          _react2.default.createElement(_reactContenteditable2.default, {
            onChange: function onChange(e) {
              return _this5.onInputChanged(e, 'Sz');
            },
            onKeyDown: function onKeyDown(e) {
              return _this5.onKeyDownNumeric(e);
            },
        ...
        this.options.showFullModelTransform && _react2.default.createElement(
          'div',
          { className: 'row' },
          _react2.default.createElement(
            'label',
          ...
          _react2.default.createElement(_Switch2.default, { onChange: function onChange(checked) {
              _this5.onFullModelTransformChecked(checked);
            }
          })
        )
      );
...
Autodesk.Viewing.theExtensionManager.registerExtension(ModelTransformerExtension.ExtensionId, ModelTransformerExtension);

/* REACT HOT LOADER */ }).call(this); } finally { if (true) { (function () { var foundReactClasses = module.hot.data && module.hot.data.foundReactClasses || false; if (module.exports && module.makeHot) { var makeExportsHot = __webpack_require__(13); if (makeExportsHot(module, __webpack_require__(0))) { foundReactClasses = true; } var shouldAcceptModule = true && foundReactClasses; if (shouldAcceptModule) { module.hot.accept(function (err) { if (err) { console.error("Cannot apply hot update to " + "Viewing.Extension.ModelTransformer.js" + ": " + err.message); } }); } } module.hot.dispose(function (data) { data.makeHot = module.makeHot; data.foundReactClasses = foundReactClasses; }); })(); } }
/* WEBPACK VAR INJECTION */}.call(exports, __webpack_require__(9)(module)))
...
if(true) {
	// When the styles change, update the <style> tags
	if(!content.locals) {
		module.hot.accept(1401, function() {
			var newContent = __webpack_require__(1401);
			if(typeof newContent === 'string') newContent = [[module.i, newContent, '']];
			update(newContent);
		});
	}
