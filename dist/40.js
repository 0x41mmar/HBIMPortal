...
exports.default = 'Viewing.Extension.DualViewer';
...
var DualViewerExtension = function (_ExtensionBase) {
  (0, _inherits3.default)(DualViewerExtension, _ExtensionBase);

  /////////////////////////////////////////////////////////
  // Class constructor
  //
  /////////////////////////////////////////////////////////
  function DualViewerExtension(viewer, options) {
    (0, _classCallCheck3.default)(this, DualViewerExtension);

    var _this = (0, _possibleConstructorReturn3.default)(this, (DualViewerExtension.__proto__ || (0, _getPrototypeOf2.default)(DualViewerExtension)).call(this, viewer, options));

    _this.onSelectionChanged = _this.onSelectionChanged.bind(_this);

    _this.onStopResize = _this.onStopResize.bind(_this);

    _this.onResize = (0, _throttle2.default)(_this.onResize, 100);
  ...
  (0, _createClass3.default)(DualViewerExtension, [{
    key: 'load',
    ...
    key: 'onViewerCreated',
    value: function () {
      var _ref = (0, _asyncToGenerator3.default)( /*#__PURE__*/_regenerator2.default.mark(function _callee(viewer) {
        var _this3 = this;
          ...
          while (1) {
            switch (_context.prev = _context.next) {
              case 0:
                ...
                _context.t0 = this.options.viewerDocument;
                ...
                _context.next = 8;
                return _Viewer4.default.loadDocument(this.options.model.urn);

              case 8:
                _context.t0 = _context.sent;

              case 9:
                this.viewerDocument = _context.t0;
                items = _Viewer4.default.getViewableItems(this.viewerDocument, '2d');
              ...
              case 14:
                ...
                this.dualViewer.addEventListener(Autodesk.Viewing.SELECTION_CHANGED_EVENT, function (e) {

                  if (!_this3.selection2Locked) {
                    _this3.selection1Locked = true;
                    _this3.viewer.select(e.dbIdArray);
                    _this3.selection1Locked = false;
                  }
                });
      ...
      var menuItems = state.items.map(function (item, idx) {
        return _react2.default.createElement(
          ...
          { eventKey: idx, key: idx, onClick: function onClick() {
              ...
              _this4.setActiveView(item);

              _this4.pathIndex = idx;
            } },
          item.name
        );
      });
        ...
        return _regenerator2.default.wrap(function _callee2$(_context2) {
          while (1) {
            switch (_context2.prev = _context2.next) {
              ...
              case 2:
                path = this.viewerDocument.getViewablePath(item);
                ...
                this.dualViewer.loadModel(path, options, function (model) {

                  _this5.dualViewer.fitToView();

                  _this5.viewerModel = model;
    ...
    value: function render() {
      ...
      return _react2.default.createElement(
        ...
        _react2.default.createElement(_Viewer6.default, { flex: 0.40,
          onViewerCreated: function onViewerCreated(viewer) {
            clearTimeout(_this6.timeoutId);
            _this6.timeoutId = setTimeout(function () {
              return _this6.onViewerCreated(viewer);
            }, 250);
          },
          className: this.className
        })
...
/* REACT HOT LOADER */ }).call(this); } finally { if (true) { (function () { var foundReactClasses = module.hot.data && module.hot.data.foundReactClasses || false; if (module.exports && module.makeHot) { var makeExportsHot = __webpack_require__(13); if (makeExportsHot(module, __webpack_require__(0))) { foundReactClasses = true; } var shouldAcceptModule = true && foundReactClasses; if (shouldAcceptModule) { module.hot.accept(function (err) { if (err) { console.error("Cannot apply hot update to " + "Viewing.Extension.DualViewer.js" + ": " + err.message); } }); } } module.hot.dispose(function (data) { data.makeHot = module.makeHot; data.foundReactClasses = foundReactClasses; }); })(); } }
...
if(true) {
	// When the styles change, update the <style> tags
	if(!content.locals) {
		module.hot.accept(1387, function() {
			var newContent = __webpack_require__(1387);
			if(typeof newContent === 'string') newContent = [[module.i, newContent, '']];
			update(newContent);
		});
	}
