...
// module
exports.push([module.i, ".force-graph {\n  background-color: #fdfdfd;\n  -webkit-user-select: none;\n     -moz-user-select: none;\n      -ms-user-select: none;\n          user-select: none;\n  overflow: visible;\n  height: 100%;\n  width: 100%; }\n  .force-graph .node {\n    cursor: pointer;\n    stroke: #3182bd;\n    stroke-width: 1.5px; }\n  .force-graph .link {\n    fill: none;\n    stroke: #9ecae1;\n    stroke-width: 1.5px; }\n", ""]);
...
exports.default = 'Viewing.Extension.ForceGraph';
...
var ForceGraph = function (_React$Component) {
  (0, _inherits3.default)(ForceGraph, _React$Component);
  ...
  function ForceGraph(props) {
    (0, _classCallCheck3.default)(this, ForceGraph);
    return (0, _possibleConstructorReturn3.default)(this, (ForceGraph.__proto__ || (0, _getPrototypeOf2.default)(ForceGraph)).call(this, props));
  }
  ...
  (0, _createClass3.default)(ForceGraph, [{
    ...
    value: function draw(root) {
      ...
      var force = _d2.default.layout.force().size([width, height]).on("tick", function () {
        return tick();
      });

      var svg = _d2.default.select(container).append("svg").attr("width", width).attr("height", height);
      ...
      var update = function update() {
        ...
        var nodes = _this2.flatten(root);
        var links = _d2.default.layout.tree().links(nodes);
        ...
        node.enter().append("circle").attr("class", "node").attr("cx", function (d) {
          ...
          return size;
        }).style("fill", color).on("dblclick", onDoubleClick).on("click", function (n) {
          if (_this2.props.onNodeClicked) {
            _this2.props.onNodeClicked(n);
          }
        }).call(force.drag);
      };
      ...
      var onDoubleClick = function onDoubleClick(d) {

        if (!_d2.default.event.defaultPrevented) {
    ...
    value: function render() {
      ...
      return _react2.default.createElement('div', { className: 'force-graph',
...
/* REACT HOT LOADER */ }).call(this); } finally { if (true) { (function () { var foundReactClasses = module.hot.data && module.hot.data.foundReactClasses || false; if (module.exports && module.makeHot) { var makeExportsHot = __webpack_require__(13); if (makeExportsHot(module, __webpack_require__(0))) { foundReactClasses = true; } var shouldAcceptModule = true && foundReactClasses; if (shouldAcceptModule) { module.hot.accept(function (err) { if (err) { console.error("Cannot apply hot update to " + "ForceGraph.js" + ": " + err.message); } }); } } module.hot.dispose(function (data) { data.makeHot = module.makeHot; data.foundReactClasses = foundReactClasses; }); })(); } }
...
var _ForceGraph = __webpack_require__(1643);

var _ForceGraph2 = _interopRequireDefault(_ForceGraph);

function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

exports.default = _ForceGraph2.default;
...
var _ForceGraph = __webpack_require__(1644);
...
//
/////////////////////////////////////////////////////////
var ForceGraphExtension = function (_MultiModelExtensionB) {
  (0, _inherits3.default)(ForceGraphExtension, _MultiModelExtensionB);

  /////////////////////////////////////////////////////////
  // Class constructor
  //
  /////////////////////////////////////////////////////////
  function ForceGraphExtension(viewer, options) {
    (0, _classCallCheck3.default)(this, ForceGraphExtension);

    var _this = (0, _possibleConstructorReturn3.default)(this, (ForceGraphExtension.__proto__ || (0, _getPrototypeOf2.default)(ForceGraphExtension)).call(this, viewer, options));
  ...
  (0, _createClass3.default)(ForceGraphExtension, [{
    key: 'load',
    ...
    value: function load() {
      ...
      this.react.setState({
        ...
        var model = _this2.viewer.activeModel;

        if (model) {

          _this2.loadGraph(model);
        }
      });
        ...
        buildMenu: function buildMenu(menu, selectedDbId) {
          return !selectedDbId ? [{
            ...
            target: function target() {
              _Viewer6.default.isolateFull(_this2.viewer);
    ...
    value: function unload() {
      ...
      (0, _get3.default)(ForceGraphExtension.prototype.__proto__ || (0, _getPrototypeOf2.default)(ForceGraphExtension.prototype), 'unload', this).call(this);
        ...
        return _regenerator2.default.wrap(function _callee$(_context) {
          while (1) {
            switch (_context.prev = _context.next) {
              ...
              case 2:
                _context.next = 4;
                return _Viewer6.default.getLeafNodes(model);

              case 4:
                this.componentIds = _context.sent;
                _context.t0 = this.options.graphProperties;
                ...
                _context.next = 9;
                return _Viewer6.default.getPropertyList(this.viewer, this.componentIds, model);

              case 9:
                _context.t0 = _context.sent;

              case 10:
                graphProperties = _context.t0;


                $('#force-graph-dropdown').parent().find('ul').css({
                  height: Math.min($('.force-graph').height() - 42, graphProperties.length * 26 + 16)
                });
              ...
              case 14:
                ...
                this.setActiveProperty(graphProperties[this.options.defaultIndex || 0]);
    ...
    value: function () {
      var _ref2 = (0, _asyncToGenerator3.default)( /*#__PURE__*/_regenerator2.default.mark(function _callee2(propName, disable) {
        var root;
        return _regenerator2.default.wrap(function _callee2$(_context2) {
          while (1) {
            switch (_context2.prev = _context2.next) {
              ...
              case 2:
                _context2.next = 4;
                return this.buildDataTree(propName);
      ...
      function setActiveProperty(_x2, _x3) {
        return _ref2.apply(this, arguments);
      }

      return setActiveProperty;
    }()
    ...
    key: 'buildDataTree',
    value: function () {
      var _ref3 = (0, _asyncToGenerator3.default)( /*#__PURE__*/_regenerator2.default.mark(function _callee4(propName) {
        var _this3 = this;
        ...
        return _regenerator2.default.wrap(function _callee4$(_context4) {
          while (1) {
            switch (_context4.prev = _context4.next) {
              case 0:
                model = this.viewer.activeModel;
                _context4.next = 3;
                return _Viewer6.default.buildModelTree(model);
              ...
              case 3:
                        ...
                        while (1) {
                          switch (_context3.prev = _context3.next) {
                            case 0:
                              ...
                              _context3.next = 4;
                              return _Viewer6.default.getProperty(model, node.dbId, propName);
                ...
                _context4.next = 7;
                return _Viewer6.default.runTaskOnDataTree(root, taskFunc);
    ...
    value: function normalize(root) {
      ...
      var computeMinMaxRec = function computeMinMaxRec(node) {
      ...
      var normalizeRec = function normalizeRec(node) {
    ...
    value: function onStopResize() {
      ...
      $('#force-graph-dropdown').parent().find('ul').css({
        height: Math.min($('.force-graph').height() - 42, state.items.length * 26 + 16)
      });
    ...
    value: function renderTitle() {
      ...
      var menuItems = state.items.map(function (item, idx) {
        return _react2.default.createElement(
          _reactBootstrap.MenuItem,
          { eventKey: idx, key: idx, onClick: function onClick() {

              _this4.setActiveProperty(item, true);
            } },
          item
        );
      });
    ...
    value: function render() {
      ...
      return _react2.default.createElement(
        ...
        _react2.default.createElement(_ForceGraph2.default, { onNodeClicked: function onNodeClicked(node) {

            _Viewer6.default.isolateFull(_this5.viewer, node.dbId, _this5.viewer.activeModel);

            _this5.viewer.fitToView();
          },
          guid: state.guid,
          root: state.root
        })
  ...
  return ForceGraphExtension;
}(_Viewer2.default);

Autodesk.Viewing.theExtensionManager.registerExtension(ForceGraphExtension.ExtensionId, ForceGraphExtension);

/* REACT HOT LOADER */ }).call(this); } finally { if (true) { (function () { var foundReactClasses = module.hot.data && module.hot.data.foundReactClasses || false; if (module.exports && module.makeHot) { var makeExportsHot = __webpack_require__(13); if (makeExportsHot(module, __webpack_require__(0))) { foundReactClasses = true; } var shouldAcceptModule = true && foundReactClasses; if (shouldAcceptModule) { module.hot.accept(function (err) { if (err) { console.error("Cannot apply hot update to " + "Viewing.Extension.ForceGraph.js" + ": " + err.message); } }); } } module.hot.dispose(function (data) { data.makeHot = module.makeHot; data.foundReactClasses = foundReactClasses; }); })(); } }
/* WEBPACK VAR INJECTION */}.call(exports, __webpack_require__(9)(module), __webpack_require__(31)))
...
if(true) {
	// When the styles change, update the <style> tags
	if(!content.locals) {
		module.hot.accept(1366, function() {
			var newContent = __webpack_require__(1366);
			if(typeof newContent === 'string') newContent = [[module.i, newContent, '']];
			update(newContent);
		});
	}
...
if(true) {
	// When the styles change, update the <style> tags
	if(!content.locals) {
		module.hot.accept(1390, function() {
			var newContent = __webpack_require__(1390);
			if(typeof newContent === 'string') newContent = [[module.i, newContent, '']];
			update(newContent);
		});
	}
