...
exports.default = 'Viewing.Extension.BoundingBox';
...
//
/////////////////////////////////////////////////////////////////
var BoundingBoxExtension = function (_MultiModelExtensionB) {
    (0, _inherits3.default)(BoundingBoxExtension, _MultiModelExtensionB);

    /////////////////////////////////////////////////////////
    // Class constructor
    //
    /////////////////////////////////////////////////////////
    function BoundingBoxExtension(viewer, options) {
        (0, _classCallCheck3.default)(this, BoundingBoxExtension);

        var _this = (0, _possibleConstructorReturn3.default)(this, (BoundingBoxExtension.__proto__ || (0, _getPrototypeOf2.default)(BoundingBoxExtension)).call(this, viewer, options));

        _this.onContextMenu = _this.onContextMenu.bind(_this);

        _this.linesMaterial = _this.createMaterial(0x0000FF);
    ...
    (0, _createClass3.default)(BoundingBoxExtension, [{
        key: 'createMaterial',
        ...
        value: function load() {
            ...
            this.viewer.impl.createOverlayScene('boundingBox', this.linesMaterial);
        ...
        value: function unload() {
            ...
            (0, _get3.default)(BoundingBoxExtension.prototype.__proto__ || (0, _getPrototypeOf2.default)(BoundingBoxExtension.prototype), 'unload', this).call(this);
                    ...
                    while (1) {
                        switch (_context.prev = _context.next) {
                            case 0:
                                ...
                                _context.next = 6;
                                return _Viewer4.default.getWorldBoundingBox(model, this.selectedDbId);
        ...
        value: function drawBox(bbox) {
            ...
            var lines = new THREE.Line(geometry, this.linesMaterial, THREE.LinePieces);
            ...
            if (this.lineGroups.length) {
                ...
                event.menu.push({
                    ...
                    target: function target() {
                        _this3.lineGroups.forEach(function (lines) {

                            _this3.viewer.impl.removeOverlay('boundingBox', lines);
                        });

                        _this3.viewer.impl.invalidate(true, true, true);
...
Autodesk.Viewing.theExtensionManager.registerExtension(BoundingBoxExtension.ExtensionId, BoundingBoxExtension);

exports.default = 'Viewing.Extension.BoundingBox';

/* REACT HOT LOADER */ }).call(this); } finally { if (true) { (function () { var foundReactClasses = module.hot.data && module.hot.data.foundReactClasses || false; if (module.exports && module.makeHot) { var makeExportsHot = __webpack_require__(13); if (makeExportsHot(module, __webpack_require__(0))) { foundReactClasses = true; } var shouldAcceptModule = true && foundReactClasses; if (shouldAcceptModule) { module.hot.accept(function (err) { if (err) { console.error("Cannot apply hot update to " + "Viewing.Extension.BoundingBox.js" + ": " + err.message); } }); } } module.hot.dispose(function (data) { data.makeHot = module.makeHot; data.foundReactClasses = foundReactClasses; }); })(); } }
/* WEBPACK VAR INJECTION */}.call(exports, __webpack_require__(9)(module)))
