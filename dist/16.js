...
// module
exports.push([module.i, ".data-management .title {\n  display: -webkit-inline-box;\n  display: -ms-inline-flexbox;\n  display: inline-flex;\n  float: left; }\n\n.data-management .title > label {\n  -webkit-user-select: none;\n  -moz-user-select: none;\n  -ms-user-select: none;\n  white-space: nowrap;\n  font-weight: normal;\n  user-select: none;\n  margin-left: 27px;\n  margin-top: 10px;\n  select: none;\n  width: 142px;\n  float: left; }\n\n.data-management .content {\n  height: 100%; }\n\n.data-management .content > .controls {\n  position: absolute;\n  width: 100%; }\n\n.data-management .tab-content {\n  border-bottom: 1px solid #888888;\n  border-right: 1px solid #888888;\n  border-left: 1px solid #888888;\n  height: calc(100% - 28px);\n  background: #fafafa;\n  overflow-y: scroll; }\n\n.data-management .tabs-container {\n  height: calc(100% - 8px);\n  width: calc(100% - 8px);\n  margin: 4px; }\n  .data-management .tabs-container .tabs {\n    height: 100%; }\n\n.data-management .nav-tabs {\n  border-bottom: 1px solid #ddd;\n  overflow: scroll;\n  height: 30px; }\n  .data-management .nav-tabs li {\n    overflow: hidden;\n    height: 30px;\n    float: left; }\n    .data-management .nav-tabs li.active > a {\n      background-color: #ffffff;\n      border-bottom: none; }\n\n.data-management .nav-tabs > li > a {\n  background-color: #fafafa;\n  border: 1px solid #888888;\n  white-space: nowrap;\n  padding: 4px 6px;\n  outline: none;\n  height: 100%; }\n  .data-management .nav-tabs > li > a label {\n    pointer-events: none;\n    overflow: hidden; }\n\n.data-management.popover {\n  max-width: -webkit-max-content;\n  max-width: -moz-max-content;\n  max-width: max-content; }\n  .data-management.popover .popover-content .versions {\n    max-height: 205px;\n    overflow: scroll; }\n    .data-management.popover .popover-content .versions .version {\n      transition-property: background, border;\n      transition-timing-function: ease;\n      transition-duration: 1.5s;\n      transition-delay: 0.0s;\n      background: #f7f7f7;\n      margin-bottom: 4px;\n      cursor: pointer;\n      padding: 6px; }\n      .data-management.popover .popover-content .versions .version:hover {\n        background: #bcdaff; }\n      .data-management.popover .popover-content .versions .version.active label {\n        margin-left: 0px; }\n      .data-management.popover .popover-content .versions .version label {\n        pointer-events: none;\n        font-weight: normal;\n        margin-left: 22px; }\n      .data-management.popover .popover-content .versions .version span {\n        pointer-events: none;\n        position: relative;\n        margin-right: 4px;\n        font-size: 18px;\n        color: green;\n        top: 2px; }\n\n.data-management-controls {\n  margin: auto 0 auto calc(100% - 173px);\n  position: relative;\n  float: left; }\n\n.data-management-controls > button {\n  border: 1px solid #c6c6c6;\n  background-color: #e1e1e1;\n  border-radius: 6px;\n  position: relative;\n  overflow: hidden;\n  outline: none;\n  height: 24px;\n  width: 26px; }\n\n.data-management-controls > button:hover {\n  border: 1px solid #878787;\n  background-color: #f5f5f5; }\n\n.data-management-controls > button > label {\n  position: relative;\n  font-size: 20px;\n  color: #f0fcff;\n  top: -8px; }\n\n.data-management-controls > button > span {\n  pointer-events: none;\n  color: #9b9b9b; }\n", ""]);
...
exports.default = 'Viewing.Extension.DataManagement';
...
/////////////////////////////////////////////////////////
var DataManagementAPI = function (_ClientAPI) {
  (0, _inherits3.default)(DataManagementAPI, _ClientAPI);

  function DataManagementAPI(opts) {
    (0, _classCallCheck3.default)(this, DataManagementAPI);
    return (0, _possibleConstructorReturn3.default)(this, (DataManagementAPI.__proto__ || (0, _getPrototypeOf2.default)(DataManagementAPI)).call(this, opts.apiUrl));
  }
  ...
  (0, _createClass3.default)(DataManagementAPI, [{
    key: 'getHubs',
    ...
    key: 'getHubHeader',
    value: function getHubHeader(hub) {
    ...
    key: 'getProjects',
    value: function getProjects(hubId) {

      var url = '/hubs/' + hubId + '/projects';
    ...
    key: 'getProject',
    value: function getProject(hubId, projectId) {

      var url = '/hubs/' + hubId + '/projects/' + projectId;
    ...
    value: function getProjectTopFolders(hubId, projectId) {

      var url = '/hubs/' + hubId + '/projects/' + projectId + '/topFolders';
    ...
    key: 'getFolder',
    value: function getFolder(projectId, folderId) {

      var url = '/projects/' + projectId + '/folders/' + folderId;
    ...
    value: function getFolderContent(projectId, folderId) {

      var url = '/projects/' + projectId + '/folders/' + folderId + '/content';
    ...
    key: 'getItem',
    value: function getItem(projectId, itemId) {

      var url = '/projects/' + projectId + '/items/' + itemId;
    ...
    key: 'deleteItem',
    value: function deleteItem(projectId, itemId) {
    ...
    key: 'getItemVersions',
    value: function getItemVersions(projectId, itemId) {

      var url = '/projects/' + projectId + '/items/' + itemId + '/versions';
    ...
    key: 'getItemTip',
    value: function getItemTip(projectId, itemId) {

      var url = '/projects/' + projectId + '/items/' + itemId + '/tip';
    ...
    key: 'getVersion',
    value: function getVersion(projectId, versionId) {

      var encodedVersionId = encodeURIComponent(versionId);

      var url = '/projects/' + projectId + '/versions/' + encodedVersionId;
    ...
    value: function getItemRelationshipsRefs(projectId, itemId) {

      var url = '/projects/' + projectId + '/items/' + itemId + '/relationships/refs';
    ...
    value: function getVersionRelationshipsRefs(projectId, versionId) {

      var encodedVersionId = encodeURIComponent(versionId);

      var url = '/projects/' + projectId + '/versions/' + (encodedVersionId + '/relationships/refs');
    ...
    key: 'postItemRelationshipRef',
    value: function postItemRelationshipRef(projectId, itemId, refVersionId) {
    ...
    key: 'postVersionRelationshipRef',
    value: function postVersionRelationshipRef(projectId, versionId, refVersionId) {
    ...
    key: 'postFolder',
    value: function postFolder(projectId, parentFolderId, folderName) {

      var url = '/projects/' + projectId + '/folders';
    ...
    value: function download(version) {
      ...
      var objectId = this.parseObjectId(version.relationships.storage.data.id);

      var uri = '/buckets/' + objectId.bucketKey + '/objects/' + objectId.objectKey;
    ...
    key: 'getVersionURN',
    value: function getVersionURN(version) {
      var useStorage = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : false;
      ...
      if (version.relationships.storage) {
        ...
        var urn = window.btoa(version.relationships.storage.data.id);
...
exports.default = DataManagementAPI;

/* REACT HOT LOADER */ }).call(this); } finally { if (true) { (function () { var foundReactClasses = module.hot.data && module.hot.data.foundReactClasses || false; if (module.exports && module.makeHot) { var makeExportsHot = __webpack_require__(13); if (makeExportsHot(module, __webpack_require__(0))) { foundReactClasses = true; } var shouldAcceptModule = true && foundReactClasses; if (shouldAcceptModule) { module.hot.accept(function (err) { if (err) { console.error("Cannot apply hot update to " + "DM.API.js" + ": " + err.message); } }); } } module.hot.dispose(function (data) { data.makeHot = module.makeHot; data.foundReactClasses = foundReactClasses; }); })(); } }
/* WEBPACK VAR INJECTION */}.call(exports, __webpack_require__(9)(module)))
...
var _flattenDeep = __webpack_require__(1623);
...
var DerivativesSvc = function (_ClientAPI) {
  (0, _inherits3.default)(DerivativesSvc, _ClientAPI);

  /////////////////////////////////////////////////////////
  //
  //
  /////////////////////////////////////////////////////////
  function DerivativesSvc(config) {
    (0, _classCallCheck3.default)(this, DerivativesSvc);
    return (0, _possibleConstructorReturn3.default)(this, (DerivativesSvc.__proto__ || (0, _getPrototypeOf2.default)(DerivativesSvc)).call(this, config.apiUrl));
  }
  ...
  (0, _createClass3.default)(DerivativesSvc, [{
    key: 'name',
    value: function name() {
    ...
    key: 'getManifest',
    value: function getManifest(urn) {

      var url = '/manifest/' + urn;
    ...
    key: 'getThumbnailUrl',
    value: function getThumbnailUrl(urn) {
      var options = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : { size: 200 };


      var query = 'width=' + options.size + '&height=' + options.size;
    ...
    key: 'getThumbnail',
    value: function getThumbnail(urn) {
      var options = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : {
        base64: false,
        size: 200
      };
    ...
    value: function findDerivatives(parent, query) {
      ...
      if (derivatives) {
        ...
        var childResults = derivatives.map(function (derivative) {
          ...
          return _this2.findDerivatives(derivative, query);
        });

        return (0, _flattenDeep2.default)([].concat((0, _toConsumableArray3.default)(matches), (0, _toConsumableArray3.default)(childResults)));
      }
    }
...
exports.default = DerivativesSvc;

/* REACT HOT LOADER */ }).call(this); } finally { if (true) { (function () { var foundReactClasses = module.hot.data && module.hot.data.foundReactClasses || false; if (module.exports && module.makeHot) { var makeExportsHot = __webpack_require__(13); if (makeExportsHot(module, __webpack_require__(0))) { foundReactClasses = true; } var shouldAcceptModule = true && foundReactClasses; if (shouldAcceptModule) { module.hot.accept(function (err) { if (err) { console.error("Cannot apply hot update to " + "Derivatives.API.js" + ": " + err.message); } }); } } module.hot.dispose(function (data) { data.makeHot = module.makeHot; data.foundReactClasses = foundReactClasses; }); })(); } }
/* WEBPACK VAR INJECTION */}.call(exports, __webpack_require__(9)(module)))
...
var _Derivatives = __webpack_require__(1683);
...
var _DataTreeView = __webpack_require__(1340);
...
var _reactMeasure = __webpack_require__(1154);
...
var _DM = __webpack_require__(1682);
...
//
///////////////////////////////////////////////////////////
var DataManagementExtension = function (_MultiModelExtensionB) {
  (0, _inherits3.default)(DataManagementExtension, _MultiModelExtensionB);

  /////////////////////////////////////////////////////////
  // Class constructor
  //
  /////////////////////////////////////////////////////////
  function DataManagementExtension(viewer, options) {
    (0, _classCallCheck3.default)(this, DataManagementExtension);

    var _this = (0, _possibleConstructorReturn3.default)(this, (DataManagementExtension.__proto__ || (0, _getPrototypeOf2.default)(DataManagementExtension)).call(this, viewer, options));

    _this.onItemNodeCreated = _this.onItemNodeCreated.bind(_this);
    ...
    _this.derivativesAPI = new _Derivatives2.default({
      apiUrl: '/api/derivatives/3legged'
    });

    _this.dmAPI = new _DM2.default({
      apiUrl: '/api/dm'
    });
  ...
  (0, _createClass3.default)(DataManagementExtension, [{
    key: 'load',
    value: function load() {
      var _this2 = this;
        ...
        return _regenerator2.default.wrap(function _callee$(_context) {
          while (1) {
            switch (_context.prev = _context.next) {
              case 0:
                _context.next = 2;
                return _this2.react.pushRenderExtension(_this2);
              ...
              case 2:
                ...
                _context.prev = 3;
                _context.next = 6;
                return _this2.forgeSvc.getUser();
              ...
              case 10:
                ...
                return _context.abrupt('return', _this2.showLogin());
              ...
              case 13:
                ...
                _context.next = 16;
                return _this2.dmAPI.getHubs();

              case 16:
                hubsRes = _context.sent;
    ...
    value: function unload() {
      ...
      (0, _get3.default)(DataManagementExtension.prototype.__proto__ || (0, _getPrototypeOf2.default)(DataManagementExtension.prototype), 'unload', this).call(this);
    ...
    key: 'setViewerUrn',
    value: function () {
      var _ref2 = (0, _asyncToGenerator3.default)( /*#__PURE__*/_regenerator2.default.mark(function _callee2(node, urn) {
        var manifest;
        return _regenerator2.default.wrap(function _callee2$(_context2) {
          while (1) {
            switch (_context2.prev = _context2.next) {
              case 0:
                _context2.prev = 0;
                _context2.next = 3;
                return this.derivativesAPI.getManifest(urn);

              case 3:
                manifest = _context2.sent;


                if (this.derivativesAPI.hasDerivative(manifest, { type: 'geometry' })) {
    ...
    key: 'setNodeViewerUrn',
    value: function () {
      var _ref3 = (0, _asyncToGenerator3.default)( /*#__PURE__*/_regenerator2.default.mark(function _callee3(node, urn) {
        var manifest;
        return _regenerator2.default.wrap(function _callee3$(_context3) {
          while (1) {
            switch (_context3.prev = _context3.next) {
      ...
      function setNodeViewerUrn(_x3, _x4) {
        return _ref3.apply(this, arguments);
      }

      return setNodeViewerUrn;
    }()
    ...
    key: 'setNodeThumbnail',
    value: function () {
      var _ref4 = (0, _asyncToGenerator3.default)( /*#__PURE__*/_regenerator2.default.mark(function _callee4(node, urn) {
          ...
          while (1) {
            switch (_context4.prev = _context4.next) {
              case 0:
                _context4.prev = 0;
                _context4.next = 3;
                return this.derivativesAPI.getThumbnail(urn, {
                  size: 200, base64: true
                });

              case 3:
                thumbnail = _context4.sent;
                base64 = 'data:image/png;base64,' + thumbnail;
      ...
      function setNodeThumbnail(_x5, _x6) {
        return _ref4.apply(this, arguments);
      }

      return setNodeThumbnail;
    }()
    ...
    key: 'onItemNodeCreated',
    value: function () {
      var _ref5 = (0, _asyncToGenerator3.default)( /*#__PURE__*/_regenerator2.default.mark(function _callee5(node) {
        var versionsRes, versions, urn;
        return _regenerator2.default.wrap(function _callee5$(_context5) {
          while (1) {
            switch (_context5.prev = _context5.next) {
              case 0:
                _context5.next = 2;
                return this.dmAPI.getItemVersions(node.props.projectId, node.props.itemId);

              case 2:
                versionsRes = _context5.sent;
                ...
                urn = this.dmAPI.getVersionURN(node.activeVersion);
                ...
                _context5.next = 10;
                return this.setNodeViewerUrn(node, urn);
              ...
              case 10:
                ...
                _context5.next = 13;
                return this.setNodeThumbnail(node, urn);
      ...
      function onItemNodeCreated(_x7) {
        return _ref5.apply(this, arguments);
      }

      return onItemNodeCreated;
    }()
    ...
    key: 'getVersionFileType',
    value: function getVersionFileType(version) {
      ...
      if (version.attributes.fileType) {
        ...
        var fileId = version.relationships.storage.data.id;
    ...
    key: 'onLoadItem',
    value: function () {
      var _ref6 = (0, _asyncToGenerator3.default)( /*#__PURE__*/_regenerator2.default.mark(function _callee6(node) {
        var extId, loader, version;
          ...
          while (1) {
            switch (_context6.prev = _context6.next) {
              case 0:
                ...
                _context6.prev = 2;
                extId = 'Viewing.Extension.ModelLoader';
                loader = this.viewer.getExtension(extId);
                version = node.activeVersion;
                _context6.next = 8;
    ...
    key: 'setDocking',
    value: function () {
      var _ref7 = (0, _asyncToGenerator3.default)( /*#__PURE__*/_regenerator2.default.mark(function _callee7(docked) {
        var id;
        return _regenerator2.default.wrap(function _callee7$(_context7) {
          while (1) {
            switch (_context7.prev = _context7.next) {
              case 0:
                id = DataManagementExtension.ExtensionId;
    ...
    value: function renderTitle(docked) {
      ...
      return _react2.default.createElement(
        ...
        _react2.default.createElement(
          'div',
          { className: 'data-management-controls' },
          _react2.default.createElement(
            'button',
            { onClick: function onClick() {
    ...
    key: 'onTabSelected',
    value: function onTabSelected(tabKey) {
    ...
    key: 'renderHubs',
    value: function renderHubs(hubs) {
      var _this5 = this;

      var _react$getState = this.react.getState(),
          activeTabKey = _react$getState.activeTabKey,
          tabsWidth = _react$getState.tabsWidth;

      var tabs = hubs.map(function (hub) {

        var hubHeader = _this5.dmAPI.getHubHeader(hub);

        var style = {
          width: Math.floor((tabsWidth - 8) / hubs.length - 15) + 'px'
        };
        ...
        return _react2.default.createElement(
          ...
          { className: 'tab-container',
            ...
            title: title,
            key: hub.id },
          _react2.default.createElement(_DataTreeView2.default, {
            onItemNodeCreated: _this5.onItemNodeCreated,
            menuContainer: _this5.options.appContainer,
            onLoadItem: _this5.onLoadItem,
            api: _this5.dmAPI,
            hub: hub
          })
        );
      ...
      return _react2.default.createElement(
        ...
        { bounds: true, onResize: function onResize(rect) {
            _this5.react.setState({
              tabsWidth: rect.bounds.width
            });
          } },
        function (_ref8) {
          var measureRef = _ref8.measureRef;
          return _react2.default.createElement(
            'div',
            { ref: measureRef, className: 'tabs-container' },
            _react2.default.createElement(
              _reactBootstrap.Tabs,
              { activeKey: activeTabKey || hubs[0].id,
                onSelect: _this5.onTabSelected,
                className: 'tabs',
                id: 'hubs-tab' },
              tabs
            )
    ...
    value: function render(opts) {
      ...
      var _react$getState3 = this.react.getState(),
          showTitle = _react$getState3.showTitle;
  ...
  return DataManagementExtension;
}(_Viewer2.default);

Autodesk.Viewing.theExtensionManager.registerExtension(DataManagementExtension.ExtensionId, DataManagementExtension);

exports.default = 'Viewing.Extension.DataManagement';

/* REACT HOT LOADER */ }).call(this); } finally { if (true) { (function () { var foundReactClasses = module.hot.data && module.hot.data.foundReactClasses || false; if (module.exports && module.makeHot) { var makeExportsHot = __webpack_require__(13); if (makeExportsHot(module, __webpack_require__(0))) { foundReactClasses = true; } var shouldAcceptModule = true && foundReactClasses; if (shouldAcceptModule) { module.hot.accept(function (err) { if (err) { console.error("Cannot apply hot update to " + "Viewing.Extension.DataManagement.js" + ": " + err.message); } }); } } module.hot.dispose(function (data) { data.makeHot = module.makeHot; data.foundReactClasses = foundReactClasses; }); })(); } }
/* WEBPACK VAR INJECTION */}.call(exports, __webpack_require__(9)(module)))
...
if(true) {
	// When the styles change, update the <style> tags
	if(!content.locals) {
		module.hot.accept(1386, function() {
			var newContent = __webpack_require__(1386);
			if(typeof newContent === 'string') newContent = [[module.i, newContent, '']];
			update(newContent);
		});
	}
