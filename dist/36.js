...
exports.default = 'Viewing.Extension.WallAnalyzer';
...
var MeshPropertyPanel = function (_Autodesk$Viewing$UI$) {
  (0, _inherits3.default)(MeshPropertyPanel, _Autodesk$Viewing$UI$);

  /////////////////////////////////////////////////////////////////
  // Class constructor
  //
  /////////////////////////////////////////////////////////////////
  function MeshPropertyPanel(viewer) {
    (0, _classCallCheck3.default)(this, MeshPropertyPanel);

    var _this = (0, _possibleConstructorReturn3.default)(this, (MeshPropertyPanel.__proto__ || (0, _getPrototypeOf2.default)(MeshPropertyPanel)).call(this, viewer.container));
  ...
  (0, _createClass3.default)(MeshPropertyPanel, [{
    key: "setNodeProperties",
    value: function setNodeProperties(nodeId) {
      var _this2 = this;

      this.viewer.model.getProperties(nodeId, function (result) {

        _this2.setProperties(result.properties);

        _this2.setTitle(result.name);

        _this2.resizeToContent();

        _this2.nodeId = nodeId;
      });
    }
  }]);
  return MeshPropertyPanel;
}(Autodesk.Viewing.UI.PropertyPanel);

exports.default = MeshPropertyPanel;

/* REACT HOT LOADER */ }).call(this); } finally { if (true) { (function () { var foundReactClasses = module.hot.data && module.hot.data.foundReactClasses || false; if (module.exports && module.makeHot) { var makeExportsHot = __webpack_require__(13); if (makeExportsHot(module, __webpack_require__(0))) { foundReactClasses = true; } var shouldAcceptModule = true && foundReactClasses; if (shouldAcceptModule) { module.hot.accept(function (err) { if (err) { console.error("Cannot apply hot update to " + "MeshPropertyPanel.js" + ": " + err.message); } }); } } module.hot.dispose(function (data) { data.makeHot = module.makeHot; data.foundReactClasses = foundReactClasses; }); })(); } }
/* WEBPACK VAR INJECTION */}.call(exports, __webpack_require__(9)(module)))
...
var _MeshPropertyPanel = __webpack_require__(1751);

var _MeshPropertyPanel2 = _interopRequireDefault(_MeshPropertyPanel);

var _worker = __webpack_require__(1905);
...
var WallAnalyzerExtension = function (_MultiModelExtensionB) {
  (0, _inherits3.default)(WallAnalyzerExtension, _MultiModelExtensionB);

  /////////////////////////////////////////////////////////
  // Class constructor
  //
  /////////////////////////////////////////////////////////
  function WallAnalyzerExtension(viewer, options) {
    (0, _classCallCheck3.default)(this, WallAnalyzerExtension);

    var _this = (0, _possibleConstructorReturn3.default)(this, (WallAnalyzerExtension.__proto__ || (0, _getPrototypeOf2.default)(WallAnalyzerExtension)).call(this, viewer, options));

    _this.onLevelWallsClicked = _this.onLevelWallsClicked.bind(_this);
    _this.onLevelFloorClicked = _this.onLevelFloorClicked.bind(_this);
    _this.onEnableWireFrame = _this.onEnableWireFrame.bind(_this);
    _this.onWorkerMessage = _this.onWorkerMessage.bind(_this);
    ...
    _this.worker = new _worker2.default();

    _this.intersectMeshes = [];

    _this.nbMeshesLoaded = 0;
  ...
  (0, _createClass3.default)(WallAnalyzerExtension, [{
    key: 'load',
    ...
    value: function load() {
      ...
      this.viewer.impl.createOverlayScene('wallAnalyzer', this.linesMaterial);
    ...
    value: function unload() {
      ...
      (0, _get3.default)(WallAnalyzerExtension.prototype.__proto__ || (0, _getPrototypeOf2.default)(WallAnalyzerExtension.prototype), 'unload', this).call(this);
    ...
    key: 'onWorkerMessage',
    value: function onWorkerMessage(msg) {
      var _this3 = this;
      ...
      var material = this.levelMaterials[data.level];

      var mesh = this.buildMesh(data, material);

      var levelIdx = data.levelCount - data.level - 1;

      var level = state.levels[levelIdx] || {
        ...
        floor: {
          meshes: data.floorDbIds.map(function (dbId) {
            return _Viewer6.default.buildComponentMesh(_this3.viewer, _this3.viewer.model, dbId, null, material);
          }),
      ...
      var lines = data.pathEdges.map(function (edge) {
        ...
        geometry.vertices.push(new THREE.Vector3(edge.start.x, edge.start.y, edge.start.z));

        geometry.vertices.push(new THREE.Vector3(edge.end.x, edge.end.y, edge.end.z));

        geometry.computeLineDistances();

        return new THREE.Line(geometry, _this3.linesMaterial, THREE.LinePieces);
      });
      ...
      _Viewer6.default.getProperties(this.viewer.model, mesh.dbId).then(function (properties) {
      ...
      var progress = ++this.nbMeshesLoaded * 100 / (data.levelCount * data.wallCount);
      ...
      this.notification.message = 'Processing Meshes ' + ('- Progress: ' + progress.toFixed(2) + '%');
    ...
    value: function getComponentBoundingBox(dbId) {
    ...
    value: function onToolbarCreated(event) {
      ...
      this.panel = new _MeshPropertyPanel2.default(this.viewer);
    }
    ...
    value: function onModelRootLoaded() {
      ...
      (0, _get3.default)(WallAnalyzerExtension.prototype.__proto__ || (0, _getPrototypeOf2.default)(WallAnalyzerExtension.prototype), 'onModelRootLoaded', this).call(this);
    ...
    value: function onModelCompletedLoad(event) {
      ...
      this.getComponentsByParentName('Floors', model).then(function (floorsIds) {

        var nbFloors = floorsIds.length;

        var colors = _d2.default.scale.linear().domain([0, nbFloors * .33, nbFloors * .66, nbFloors]).range(['#FCB843', '#C2149F', '#0CC4BD', '#0270E9']);

        _this4.levelMaterials = [];
        _this4.levelColors = [];

        floorsIds.forEach(function (dbId, idx) {

          var levelMaterial = new THREE.MeshPhongMaterial({
            side: THREE.DoubleSide,
            color: colors(idx)
          });

          _this4.viewer.impl.matman().addMaterial(_this4.guid(), levelMaterial, true);

          _this4.levelMaterials.push(levelMaterial);

          _this4.levelColors.push(colors(idx));

          _this4.postComponent(dbId, 'Floors', floorsIds.length);
        });
      });

      this.getComponentsByParentName('Walls', model).then(function (wallIds) {

        wallIds.forEach(function (dbId) {

          return _this4.postComponent(dbId, 'Walls', wallIds.length);
        });
      });
    ...
    value: function () {
      var _ref = (0, _asyncToGenerator3.default)( /*#__PURE__*/_regenerator2.default.mark(function _callee() {
        var model, instanceTree, fragIds, fragList, boundingBox, msg;
        return _regenerator2.default.wrap(function _callee$(_context) {
          while (1) {
            switch (_context.prev = _context.next) {
              case 0:
                ...
                _context.next = 5;
                return _Viewer6.default.getFragIds(model, this.rootId);

              case 5:
                fragIds = _context.sent;
                fragList = model.getFragmentList();
                boundingBox = this.getModifiedWorldBoundingBox(fragIds, fragList);
                msg = {
      ...
      function postModelInfo() {
        return _ref.apply(this, arguments);
      }

      return postModelInfo;
    }()
    ...
    key: 'postComponent',
    value: function postComponent(dbId, category, count) {

      var geometry = this.getComponentGeometry(dbId);
      ...
      geometry.meshes.forEach(function (mesh, idx) {
    ...
    key: 'buildMesh',
    value: function buildMesh(data, material) {
    ...
    value: function getComponentsByParentName(name, model) {
      ...
      return parentId > 0 ? _Viewer6.default.getLeafNodes(model, parentId) : [];
    }
    ...
    key: 'getComponentGeometry',
    value: function getComponentGeometry(dbId) {
      var _this5 = this;

      var fragIds = _Viewer6.default.getLeafFragIds(this.viewer.model, dbId);

      var matrixWorld = null;

      var meshes = fragIds.map(function (fragId) {

        var renderProxy = _this5.viewer.impl.getRenderProxy(_this5.viewer.model, fragId);
    ...
    key: 'createLinesMaterial',
    value: function createLinesMaterial() {
    ...
    value: function pointerToRaycaster(domElement, camera, pointer) {
    ...
    value: function onMouseMove(event) {
      ...
      var rayCaster = this.pointerToRaycaster(this.viewer.impl.canvas, this.viewer.impl.camera, pointer);

      var intersectResults = rayCaster.intersectObjects(this.intersectMeshes, true);
    ...
    value: function onClick(event) {
      ...
      if (intersectResults.length) {
        ...
        var mesh = intersectResults[0].object;
    ...
    key: 'onLevelWallsClicked',
    value: function onLevelWallsClicked(level) {
      var _this6 = this;
      ...
      var meshes = level.walls.meshes;

      meshes.forEach(function (mesh) {

        if (level.walls.active) {

          _this6.viewer.impl.scene.add(mesh);
          _this6.intersectMeshes.push(mesh);
        } else {

          _this6.viewer.impl.scene.remove(mesh);
        }
      });

      if (!level.walls.active) {

        var meshIds = meshes.map(function (mesh) {
          return mesh.id;
        });

        this.intersectMeshes = this.intersectMeshes.filter(function (mesh) {

          return !meshIds.includes(mesh.id);
        });
      }

      var nbActiveWalls = state.levels.filter(function (level) {
        return level.walls.active;
      });

      var nbActiveFloors = state.levels.filter(function (level) {
        return level.floor.active;
      });

      if (nbActiveWalls.length + nbActiveFloors.length) {

        _Viewer6.default.hide(this.viewer, this.rootId);
        this.eventTool.activate();
      } else {

        _Viewer6.default.show(this.viewer, this.rootId);
    ...
    value: function drawLine(line) {
      ...
      this.viewer.impl.addOverlay('wallAnalyzer', line);
    }
  }, {
    key: 'clearLine',
    value: function clearLine(line) {

      this.viewer.impl.removeOverlay('wallAnalyzer', line);
    }
    ...
    key: 'onLevelFloorClicked',
    value: function onLevelFloorClicked(level) {
      var _this7 = this;
      ...
      var meshes = level.floor.meshes;

      if (level.floor.active) {

        level.floor.paths.forEach(function (path) {

          path.lines.forEach(function (line) {

            _this7.drawLine(line);
          });
        });

        meshes.forEach(function (mesh) {
          _this7.viewer.impl.scene.add(mesh);
          _this7.intersectMeshes.push(mesh);
        });
      } else {
        ...
        level.floor.paths.forEach(function (path) {
          ...
          path.lines.forEach(function (line) {
            ...
            _this7.clearLine(line);
          });
        });

        meshes.forEach(function (mesh) {
          _this7.viewer.impl.scene.remove(mesh);
        });
      ...
      var viewerState = this.viewer.getState({ viewport: true });
    ...
    key: 'onEnableWireFrame',
    value: function onEnableWireFrame(checked) {

      this.wireframe = checked;

      this.levelMaterials.forEach(function (material) {
      ...
      var _ref3 = (0, _asyncToGenerator3.default)( /*#__PURE__*/_regenerator2.default.mark(function _callee3(docked) {
        ...
        return _regenerator2.default.wrap(function _callee3$(_context3) {
          while (1) {
            switch (_context3.prev = _context3.next) {
              case 0:
                id = WallAnalyzerExtension.ExtensionId;
    ...
    key: 'onLevelReportClicked',
    value: function onLevelReportClicked(e, report) {

      e.stopPropagation();

      var data = "data:text/json;charset=utf-8," + encodeURIComponent((0, _stringify2.default)(report, null, 2));
    ...
    value: function renderContent() {
      ...
      var items = levels.map(function (level) {
        ...
        hasActiveItem = hasActiveItem || level.walls.active || level.floor.active;

        var wallsActive = level.walls.active ? ' active' : '';

        var floorActive = level.floor.active ? ' active' : '';

        var style = {
          backgroundColor: _this8.hexToRgbA(level.fillColor, 0.3),
          border: '2px solid ' + level.strokeColor
        };

        return _react2.default.createElement(
          'div',
          { key: level.walls.name, className: 'list-item' },
          _react2.default.createElement('div', { className: 'item-color', style: style }),
          _react2.default.createElement(
            'label',
            null,
            level.name
          ...
          _react2.default.createElement(
            ...
            { onClick: function onClick(e) {
                _this8.onLevelReportClicked(e, level.report);
              },
          ...
          _react2.default.createElement(
            ...
            { onClick: function onClick() {
                return _this8.onLevelFloorClicked(level);
              },
          ...
          _react2.default.createElement(
            'div',
            { onClick: function onClick() {
                return _this8.onLevelWallsClicked(level);
              },
      ...
      return _react2.default.createElement(
        'div',
        { className: 'content' },
        _react2.default.createElement(_Loader.ReactLoader, { show: state.loader }),
        _react2.default.createElement(
          'div',
          { className: 'row' },
        ...
        hasActiveItem && _react2.default.createElement(
          'div',
          { className: 'row' },
          'Enable wireframe:'
        ),
        hasActiveItem && _react2.default.createElement(
          'div',
          { className: 'row' },
          _react2.default.createElement(_Switch2.default, { className: 'control-element',
    ...
    value: function renderTitle() {
      ...
      var titleOpts = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : {};


      var docked = titleOpts.docked;
      ...
      return _react2.default.createElement(
        ...
        titleOpts.showDocking && _react2.default.createElement(
          'div',
          { className: 'wall-analyzer-controls' },
          _react2.default.createElement(
            'button',
            { onClick: function onClick() {
                return _this9.setDocking(docked);
              },
      ...
      return _react2.default.createElement(
        _WidgetContainer2.default,
        {
          renderTitle: function renderTitle() {
            return _this10.renderTitle(opts.docked);
          },
...
Autodesk.Viewing.theExtensionManager.registerExtension(WallAnalyzerExtension.ExtensionId, WallAnalyzerExtension);

/* REACT HOT LOADER */ }).call(this); } finally { if (true) { (function () { var foundReactClasses = module.hot.data && module.hot.data.foundReactClasses || false; if (module.exports && module.makeHot) { var makeExportsHot = __webpack_require__(13); if (makeExportsHot(module, __webpack_require__(0))) { foundReactClasses = true; } var shouldAcceptModule = true && foundReactClasses; if (shouldAcceptModule) { module.hot.accept(function (err) { if (err) { console.error("Cannot apply hot update to " + "Viewing.Extension.WallAnalyzer.js" + ": " + err.message); } }); } } module.hot.dispose(function (data) { data.makeHot = module.makeHot; data.foundReactClasses = foundReactClasses; }); })(); } }
/* WEBPACK VAR INJECTION */}.call(exports, __webpack_require__(9)(module)))
...
if(true) {
	// When the styles change, update the <style> tags
	if(!content.locals) {
		module.hot.accept(1410, function() {
			var newContent = __webpack_require__(1410);
			if(typeof newContent === 'string') newContent = [[module.i, newContent, '']];
			update(newContent);
		});
	}
...
module.exports = function() {
	return new Worker(__webpack_require__.p + "634a4c4f7eb0aee6fe4a.worker.js");
};
