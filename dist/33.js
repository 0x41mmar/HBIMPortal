...
exports.default = 'Viewing.Extension.PieChart';
...
var PieChartExtension = function (_MultiModelExtensionB) {
  (0, _inherits3.default)(PieChartExtension, _MultiModelExtensionB);

  /////////////////////////////////////////////////////////
  // Class constructor
  //
  /////////////////////////////////////////////////////////
  function PieChartExtension(viewer, options) {
    (0, _classCallCheck3.default)(this, PieChartExtension);

    var _this = (0, _possibleConstructorReturn3.default)(this, (PieChartExtension.__proto__ || (0, _getPrototypeOf2.default)(PieChartExtension)).call(this, viewer, options));
  ...
  (0, _createClass3.default)(PieChartExtension, [{
    key: 'load',
    ...
    value: function unload() {
      ...
      (0, _get3.default)(PieChartExtension.prototype.__proto__ || (0, _getPrototypeOf2.default)(PieChartExtension.prototype), 'unload', this).call(this);
            ...
            switch (_context.prev = _context.next) {
              ...
              case 10:
                ...
                $('#pie-chart-dropdown').parent().find('ul').css({
                  height: Math.min($('.pie-chart').height() - 42, chartProperties.length * 26 + 16)
                });
    ...
    value: function onStopResize() {
      ...
      $('#pie-chart-dropdown').parent().find('ul').css({
        height: Math.min($('.pie-chart').height() - 42, state.items.length * 26 + 16)
      });
    ...
    value: function render() {
      ...
      return _react2.default.createElement(
        ...
        _react2.default.createElement(_PieChart2.default, { onGroupClicked: function onGroupClicked(e) {
            ...
            _Viewer6.default.isolateFull(_this8.viewer, dbIds);
...
Autodesk.Viewing.theExtensionManager.registerExtension(PieChartExtension.ExtensionId, PieChartExtension);

/* REACT HOT LOADER */ }).call(this); } finally { if (true) { (function () { var foundReactClasses = module.hot.data && module.hot.data.foundReactClasses || false; if (module.exports && module.makeHot) { var makeExportsHot = __webpack_require__(13); if (makeExportsHot(module, __webpack_require__(0))) { foundReactClasses = true; } var shouldAcceptModule = true && foundReactClasses; if (shouldAcceptModule) { module.hot.accept(function (err) { if (err) { console.error("Cannot apply hot update to " + "Viewing.Extension.PieChart.js" + ": " + err.message); } }); } } module.hot.dispose(function (data) { data.makeHot = module.makeHot; data.foundReactClasses = foundReactClasses; }); })(); } }
/* WEBPACK VAR INJECTION */}.call(exports, __webpack_require__(9)(module), __webpack_require__(31)))
...
if(true) {
	// When the styles change, update the <style> tags
	if(!content.locals) {
		module.hot.accept(1404, function() {
			var newContent = __webpack_require__(1404);
			if(typeof newContent === 'string') newContent = [[module.i, newContent, '']];
			update(newContent);
		});
	}
