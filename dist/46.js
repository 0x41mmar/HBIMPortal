...
exports.default = 'Viewing.Extension.MetaProperty';
...
///////////////////////////////////////////////////////////////////////////////
var MetaPropertyPanel = function (_EventsEmitter$Compos) {
  (0, _inherits3.default)(MetaPropertyPanel, _EventsEmitter$Compos);

  function MetaPropertyPanel(viewer) {
    var opts = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : {};
    (0, _classCallCheck3.default)(this, MetaPropertyPanel);
    return (0, _possibleConstructorReturn3.default)(this, (MetaPropertyPanel.__proto__ || (0, _getPrototypeOf2.default)(MetaPropertyPanel)).call(this, viewer));
  }
  ...
  (0, _createClass3.default)(MetaPropertyPanel, [{
    key: 'refresh',
    ...
    value: function setNodeProperties(nodeId) {
      ...
      (0, _get3.default)(MetaPropertyPanel.prototype.__proto__ || (0, _getPrototypeOf2.default)(MetaPropertyPanel.prototype), 'setNodeProperties', this).call(this, nodeId);
    ...
    key: '__setProperties',
    value: function __setProperties(properties, options) {
      ...
      for (var i = 0; i < withCategories.length; i++) {
        ...
        property.displayValue = Autodesk.Viewing.Private.formatValueWithUnits(property.displayValue, property.units, property.type);
      ...
      for (var i = 0; i < withoutCategories.length; i++) {
        ...
        this.addProperty(property, hasCategories ? { localizeCategory: true } : {});
      }
    }
    ...
    key: 'addProperty',
    value: function addProperty(metaProperty, options) {
      ...
      var element = this.tree.createElement_(metaProperty, parent, options && options.localizeProperty ? { localize: true } : null);
    ...
    key: 'updateProperty',
    value: function updateProperty(metaProperty) {
      ...
      switch (metaProperty.dataType) {
        ...
        default:
          ...
          $('#' + metaProperty.id).text(metaProperty.displayValue);
    ...
    value: function setProperties(properties) {
      ...
      this.emit('setProperties', {
        ...
        _this2.__setProperties(properties);
    ...
    key: 'createPropertyName',
    value: function createPropertyName(metaProperty, displayOptions) {
    ...
    key: 'createPropertySeparator',
    value: function createPropertySeparator() {
    ...
    key: 'displayProperty',
    value: function displayProperty(metaProperty, parent, displayOptions) {

      var propertyName = this.createPropertyName(metaProperty, displayOptions);

      var separator = this.createPropertySeparator();
      ...
      switch (metaProperty.dataType) {
        ...
        case 'link':
          ...
          propertyValue = this.createLinkProperty(metaProperty, displayOptions);

          break;

        case 'img':

          propertyValue = this.createImageProperty(metaProperty, displayOptions);

          break;

        case 'file':

          propertyValue = createFileProperty(metaProperty, displayOptions);

          break;

        case 'select':

          propertyValue = this.createSelectProperty(metaProperty, displayOptions);
        ...
        default:
          ...
          propertyValue = this.createTextProperty(metaProperty, displayOptions);
    ...
    value: function createTextProperty(metaProperty, displayOptions) {
    ...
    key: 'createLinkProperty',
    value: function createLinkProperty(metaProperty, displayOptions) {
    ...
    key: 'createImageProperty',
    value: function createImageProperty(metaProperty, displayOptions) {
    ...
    key: 'createFileProperty',
    value: function createFileProperty(metaProperty, displayOptions) {
    ...
    key: 'onPropertyClick',
    value: function onPropertyClick(metaProperty, event) {
      ...
      switch (metaProperty.dataType) {
        ...
        case 'img':
          ...
          this.downloadURI(metaProperty.href, metaProperty.filename);
    ...
    key: 'guid',
    value: function guid() {
      var format = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : 'xxxx-xxxx-xxxx';
  ...
  return MetaPropertyPanel;
}(_EventsEmitter2.default.Composer(Autodesk.Viewing.Extensions.ViewerPropertyPanel));

exports.default = MetaPropertyPanel;

/* REACT HOT LOADER */ }).call(this); } finally { if (true) { (function () { var foundReactClasses = module.hot.data && module.hot.data.foundReactClasses || false; if (module.exports && module.makeHot) { var makeExportsHot = __webpack_require__(13); if (makeExportsHot(module, __webpack_require__(0))) { foundReactClasses = true; } var shouldAcceptModule = true && foundReactClasses; if (shouldAcceptModule) { module.hot.accept(function (err) { if (err) { console.error("Cannot apply hot update to " + "Viewing.Extension.MetaProperty.Panel.js" + ": " + err.message); } }); } } module.hot.dispose(function (data) { data.makeHot = module.makeHot; data.foundReactClasses = foundReactClasses; }); })(); } }
...
var _ViewingExtensionMetaProperty = __webpack_require__(1507);

var _ViewingExtensionMetaProperty2 = _interopRequireDefault(_ViewingExtensionMetaProperty);
...
var MetaPropertyExtension = function (_ExtensionBase) {
  (0, _inherits3.default)(MetaPropertyExtension, _ExtensionBase);

  /////////////////////////////////////////////////////////////////
  // Class constructor
  //
  /////////////////////////////////////////////////////////////////
  function MetaPropertyExtension(viewer) {
    var options = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : {};
    (0, _classCallCheck3.default)(this, MetaPropertyExtension);
    return (0, _possibleConstructorReturn3.default)(this, (MetaPropertyExtension.__proto__ || (0, _getPrototypeOf2.default)(MetaPropertyExtension)).call(this, viewer, options));
  }
  ...
  (0, _createClass3.default)(MetaPropertyExtension, [{
    key: 'load',
    ...
    value: function load() {
      ...
      this.panel = new _ViewingExtensionMetaProperty2.default(this.viewer, this.options);

      this.panel.on('setProperties', function (data) {

        return _this2.emit('setProperties', data);
      });
    ...
    value: function addProperties(properties) {
      ...
      properties.forEach(function (property) {
        ...
        _this3.panel.addProperty(property);
      });
    ...
    value: function updateProperties(properties) {
      ...
      properties.forEach(function (property) {
        ...
        _this4.panel.updateProperty(property);
      });
  ...
  return MetaPropertyExtension;
}(_Viewer2.default); /////////////////////////////////////////////////////////////////////
// Viewing.Extension.MetaPropertyExtension
// by Philippe Leefsma, September 2016
//
/////////////////////////////////////////////////////////////////////


Autodesk.Viewing.theExtensionManager.registerExtension(MetaPropertyExtension.ExtensionId, MetaPropertyExtension);

/* REACT HOT LOADER */ }).call(this); } finally { if (true) { (function () { var foundReactClasses = module.hot.data && module.hot.data.foundReactClasses || false; if (module.exports && module.makeHot) { var makeExportsHot = __webpack_require__(13); if (makeExportsHot(module, __webpack_require__(0))) { foundReactClasses = true; } var shouldAcceptModule = true && foundReactClasses; if (shouldAcceptModule) { module.hot.accept(function (err) { if (err) { console.error("Cannot apply hot update to " + "Viewing.Extension.MetaProperty.js" + ": " + err.message); } }); } } module.hot.dispose(function (data) { data.makeHot = module.makeHot; data.foundReactClasses = foundReactClasses; }); })(); } }
/* WEBPACK VAR INJECTION */}.call(exports, __webpack_require__(9)(module), __webpack_require__(31)))
...
if(true) {
	...
	if(!content.locals) {
		module.hot.accept(1179, function() {
			var newContent = __webpack_require__(1179);
