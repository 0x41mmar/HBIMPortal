...
// module
exports.push([module.i, ".LHC{\r\n    top: 60px;\r\n    left: 10px;\r\n    width: 202px;\r\n    height: 172px;\r\n    resize: none;\r\n}\r\n\r\n.LHC .container {\r\n    width: 100%;\r\n    padding: 2px 0 0 0;\r\n    width: calc(100% - 2px);\r\n}\r\n\r\n.LHC .dockingPanelTitle {\r\n    cursor: auto;\r\n}\r\n\r\n.LHC .list-group-item {\r\n    width: calc(100% - 22px);\r\n    height: 4px;\r\n    line-height: .3;\r\n    border-radius: 4px;\r\n    margin: 1px;\r\n    padding: 10px 10px 10px 10px;\r\n    background-color: #e8e8e8;\r\n    border: 1px solid #000;\r\n    cursor: pointer;\r\n}\r\n\r\n.LHC .list-group-item:hover {\r\n    background-color: #5BC0DE;\r\n}", ""]);
...
exports.default = 'Viewing.Extension.Particle.LHC';
...
//
/////////////////////////////////////////////////////////////////////
var LHCPanel = function (_ToolPanelBase) {
  (0, _inherits3.default)(LHCPanel, _ToolPanelBase);

  /////////////////////////////////////////////////////////////
  //
  //
  /////////////////////////////////////////////////////////////
  function LHCPanel(viewer) {
    (0, _classCallCheck3.default)(this, LHCPanel);

    var _this = (0, _possibleConstructorReturn3.default)(this, (LHCPanel.__proto__ || (0, _getPrototypeOf2.default)(LHCPanel)).call(this, viewer.container, 'Cameras', {
      shadow: false,
      movable: false,
      closable: false
    }));
  ...
  (0, _createClass3.default)(LHCPanel, [{
    key: 'htmlContent',
    value: function htmlContent(id) {
    ...
    key: 'addView',
    value: function addView(name, state) {
      var _this2 = this;

      var itemId = _ToolPanelBase3.default.guid();
      ...
      $('#' + itemId).click(function () {
        ...
        _this2.viewer.restoreState(state);
      });
    }
  }]);
  return LHCPanel;
...
var LHCExtension = function (_Autodesk$Viewing$Ext) {
  (0, _inherits3.default)(LHCExtension, _Autodesk$Viewing$Ext);

  /////////////////////////////////////////////////////////////////
  // Class constructor
  //
  /////////////////////////////////////////////////////////////////
  function LHCExtension(viewer, options) {
    (0, _classCallCheck3.default)(this, LHCExtension);

    var _this3 = (0, _possibleConstructorReturn3.default)(this, (LHCExtension.__proto__ || (0, _getPrototypeOf2.default)(LHCExtension)).call(this, viewer, options));

    _this3.options = options;

    _this3.viewer = viewer;

    _this3.panel = new LHCPanel(viewer);
    return _this3;
  }
  ...
  (0, _createClass3.default)(LHCExtension, [{
    key: 'load',
    ...
    value: function load() {
      ...
      this.panel.addView('Home', JSON.parse(states.home));

      this.panel.addView('Left Emitter', JSON.parse(states.leftEmitter));

      this.panel.addView('Right Emitter', JSON.parse(states.rightEmitter));

      this.panel.addView('Control Point1', JSON.parse(states.ctrlPoint1));

      this.panel.addView('Control Point2', JSON.parse(states.ctrlPoint2));
...
Autodesk.Viewing.theExtensionManager.registerExtension(LHCExtension.ExtensionId, LHCExtension);

/* REACT HOT LOADER */ }).call(this); } finally { if (true) { (function () { var foundReactClasses = module.hot.data && module.hot.data.foundReactClasses || false; if (module.exports && module.makeHot) { var makeExportsHot = __webpack_require__(13); if (makeExportsHot(module, __webpack_require__(0))) { foundReactClasses = true; } var shouldAcceptModule = true && foundReactClasses; if (shouldAcceptModule) { module.hot.accept(function (err) { if (err) { console.error("Cannot apply hot update to " + "Viewing.Extension.Particle.LHC.js" + ": " + err.message); } }); } } module.hot.dispose(function (data) { data.makeHot = module.makeHot; data.foundReactClasses = foundReactClasses; }); })(); } }
/* WEBPACK VAR INJECTION */}.call(exports, __webpack_require__(9)(module), __webpack_require__(31)))
...
if(true) {
	// When the styles change, update the <style> tags
	if(!content.locals) {
		module.hot.accept(1413, function() {
			var newContent = __webpack_require__(1413);
			if(typeof newContent === 'string') newContent = [[module.i, newContent, '']];
			update(newContent);
		});
	}
