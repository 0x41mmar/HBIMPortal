...
// module
exports.push([module.i, ".home {\n  overflow: hidden;\n  height: 100%; }\n\n.home .welcome {\n  position: absolute;\n  color: white;\n  width: 100%;\n  z-index: 0;\n  top: 120px; }\n\n@media screen and (min-width: 460px) {\n  .home .models {\n    border-radius: 4px;\n    position: absolute;\n    background-color: white;\n    top: calc(50% - 200px);\n    left: calc(50% - 225px);\n    height: 390px;\n    width: 450px; }\n  .home .models .responsive-grid a {\n    text-decoration: none;\n    display: inline-block;\n    margin-bottom: 4px;\n    margin-right: 10px;\n    margin-left: 10px;\n    color: #606060;\n    width: 125px; }\n  .home .models .responsive-grid img {\n    transition: -webkit-transform .2s ease-in-out;\n    transition: transform .2s ease-in-out;\n    transition: transform .2s ease-in-out, -webkit-transform .2s ease-in-out;\n    max-width: 100%;\n    display: block;\n    border: 1px solid #EAEAEA;\n    width: 115px;\n    height: 115px;\n    margin: 4px; }\n  .home .models .responsive-grid figure {\n    overflow: hidden;\n    height: 150px;\n    margin: 0; }\n  .home .models .title {\n    margin-bottom: 20px;\n    border-bottom: 2px solid #EAEAEA;\n    text-align: center;\n    overflow: hidden;\n    padding: 11px 0; }\n  .home .models .responsive-grid a:nth-of-type(4n), .home .models .responsive-grid a:first-child {\n    margin-left: 0; }\n  .home .models .responsive-grid a:nth-of-type(3n) {\n    margin-right: 0; } }\n\n@media screen and (max-width: 459px) {\n  .home .models {\n    z-index: 2;\n    border-radius: 4px;\n    position: absolute;\n    border: 1px solid #b3b3b3;\n    background-color: white;\n    top: calc(50% - 250px);\n    left: calc(50% - 150px);\n    height: 480px;\n    width: 300px; }\n  .home .models .responsive-grid a {\n    text-decoration: none;\n    display: inline-block;\n    margin-bottom: 10px;\n    margin-right: 10px;\n    margin-left: 10px;\n    color: #606060;\n    width: 125px;\n    height: 125px; }\n  .home .models .responsive-grid img {\n    transition: -webkit-transform .2s ease-in-out;\n    transition: transform .2s ease-in-out;\n    transition: transform .2s ease-in-out, -webkit-transform .2s ease-in-out;\n    max-width: 100%;\n    display: block;\n    border: none;\n    width: 115px;\n    height: 115px;\n    margin: 4px; }\n  .home .models .responsive-grid figure {\n    background-color: white;\n    border-radius: 4px;\n    overflow: hidden;\n    height: 150px;\n    margin: 0; }\n  .home .models .title {\n    border-bottom: 1px solid #cccccc;\n    margin-bottom: 10px;\n    text-align: center;\n    overflow: hidden;\n    padding-top: 3px;\n    height: 30px; }\n  .home .models .responsive-grid a:nth-of-type(2n + 1), .home .models .responsive-grid a:first-child {\n    margin-left: 0; }\n  .home .models .responsive-grid a:nth-of-type(2n) {\n    margin-right: 0; } }\n\n@media screen and (max-height: 660px) {\n  .home .models {\n    top: calc(50% - 90px);\n    height: 260px; } }\n\n.home .models {\n  overflow: hidden; }\n\n.home .models .title img {\n  margin-right: 10px;\n  margin-left: 4px;\n  height: 24px;\n  width: 24px;\n  float: left; }\n\n.home .models .content {\n  max-height: calc(100% - 42px);\n  margin-top: 6px;\n  overflow: scroll; }\n\n.home .models .responsive-grid {\n  -webkit-box-pack: center;\n      -ms-flex-pack: center;\n          justify-content: center;\n  -ms-flex-wrap: wrap;\n      flex-wrap: wrap;\n  display: -webkit-box;\n  display: -ms-flexbox;\n  display: flex; }\n\n.home .models .responsive-grid a:hover figcaption {\n  color: #333333; }\n\n.home .models .responsive-grid a img {\n  box-shadow: 0 4px 8px 0 rgba(0, 0, 0, 0.2), 0 4px 8px 0 rgba(0, 0, 0, 0.2);\n  border-radius: 4px; }\n\n.home .models .responsive-grid a img:hover {\n  -webkit-transform: scale(1.05);\n          transform: scale(1.05);\n  border: 1px solid #bbbbbb; }\n\n.home .models .responsive-grid figcaption {\n  margin: 4px; }\n", ""]);
...
var HomeView = function (_React$Component) {
  ...
  function HomeView() {
    ...
    return _ret = (_temp = (_this = (0, _possibleConstructorReturn3.default)(this, (_ref = HomeView.__proto__ || (0, _getPrototypeOf2.default)(HomeView)).call.apply(_ref, [this].concat(args))), _this), _this.state = {
      models: []
          ...
          while (1) {
            switch (_context.prev = _context.next) {
              case 0:
                ...
                this.modelSvc = _SvcManager2.default.getService('ModelSvc');

                _context.next = 4;
                return this.modelSvc.getModels('rcdb');

              case 4:
                models = _context.sent;
                modelsbyName = (0, _sortBy2.default)(models, function (model) {
                  return model.name;
                });
    ...
    value: function render() {
      ...
      return _react2.default.createElement(
        ...
        _react2.default.createElement(
          ...
          _react2.default.createElement(
            'div',
            { className: 'content responsive-grid' },
            this.state.models.map(function (model, idx) {

              var thumbnailUrl = _this2.modelSvc.getThumbnailUrl('rcdb', model._id);

              return _react2.default.createElement(
                _reactRouter.Link,
                { key: idx, to: '/database?id=' + model._id },
                _react2.default.createElement(
                  'figure',
                  null,
                  _react2.default.createElement(
...
/* REACT HOT LOADER */ }).call(this); } finally { if (true) { (function () { var foundReactClasses = module.hot.data && module.hot.data.foundReactClasses || false; if (module.exports && module.makeHot) { var makeExportsHot = __webpack_require__(13); if (makeExportsHot(module, __webpack_require__(0))) { foundReactClasses = true; } var shouldAcceptModule = true && foundReactClasses; if (shouldAcceptModule) { module.hot.accept(function (err) { if (err) { console.error("Cannot apply hot update to " + "HomeView.js" + ": " + err.message); } }); } } module.hot.dispose(function (data) { data.makeHot = module.makeHot; data.foundReactClasses = foundReactClasses; }); })(); } }
...
if(true) {
	// When the styles change, update the <style> tags
	if(!content.locals) {
		module.hot.accept(1379, function() {
			var newContent = __webpack_require__(1379);
			if(typeof newContent === 'string') newContent = [[module.i, newContent, '']];
			update(newContent);
		});
	}
...
var _HomeView = __webpack_require__(1671);
...
/* REACT HOT LOADER */ }).call(this); } finally { if (true) { (function () { var foundReactClasses = module.hot.data && module.hot.data.foundReactClasses || false; if (module.exports && module.makeHot) { var makeExportsHot = __webpack_require__(13); if (makeExportsHot(module, __webpack_require__(0))) { foundReactClasses = true; } var shouldAcceptModule = true && foundReactClasses; if (shouldAcceptModule) { module.hot.accept(function (err) { if (err) { console.error("Cannot apply hot update to " + "HomeContainer.js" + ": " + err.message); } }); } } module.hot.dispose(function (data) { data.makeHot = module.makeHot; data.foundReactClasses = foundReactClasses; }); })(); } }
/* WEBPACK VAR INJECTION */}.call(exports, __webpack_require__(9)(module)))
...
/* REACT HOT LOADER */ }).call(this); } finally { if (true) { (function () { var foundReactClasses = module.hot.data && module.hot.data.foundReactClasses || false; if (module.exports && module.makeHot) { var makeExportsHot = __webpack_require__(13); if (makeExportsHot(module, __webpack_require__(0))) { foundReactClasses = true; } var shouldAcceptModule = true && foundReactClasses; if (shouldAcceptModule) { module.hot.accept(function (err) { if (err) { console.error("Cannot apply hot update to " + "home.js" + ": " + err.message); } }); } } module.hot.dispose(function (data) { data.makeHot = module.makeHot; data.foundReactClasses = foundReactClasses; }); })(); } }
/* WEBPACK VAR INJECTION */}.call(exports, __webpack_require__(9)(module)))
