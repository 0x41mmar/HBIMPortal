...
exports.default = 'Viewing.Extension.Physics.RigidBody';
...
var _FPSMeter = __webpack_require__(1730);
...
var PhysicsExtension = function (_MultiModelExtensionB) {
  (0, _inherits3.default)(PhysicsExtension, _MultiModelExtensionB);

  /////////////////////////////////////////////////////////
  // Class constructor
  //
  /////////////////////////////////////////////////////////
  function PhysicsExtension(viewer, options) {
    (0, _classCallCheck3.default)(this, PhysicsExtension);

    var _this = (0, _possibleConstructorReturn3.default)(this, (PhysicsExtension.__proto__ || (0, _getPrototypeOf2.default)(PhysicsExtension)).call(this, viewer, options));

    _this.onTransformSelection = _this.onTransformSelection.bind(_this);
    _this.onSimulationStep = _this.onSimulationStep.bind(_this);
    _this.onEnablePhysics = _this.onEnablePhysics.bind(_this);
  ...
  (0, _createClass3.default)(PhysicsExtension, [{
    key: 'load',
    ...
    value: function unload() {
      ...
      (0, _get3.default)(PhysicsExtension.prototype.__proto__ || (0, _getPrototypeOf2.default)(PhysicsExtension.prototype), 'unload', this).call(this);
    ...
    key: 'createFPS',
    value: function createFPS() {

      $(this.viewer.container).append('<div id="physics-fps"> </div>');
      ...
      return new FPSMeter(document.getElementById('physics-fps'), {
        maxFps: 20, //expected
        smoothing: 10,
        show: 'fps',
        decimals: 1,
      ...
      var _ref = (0, _asyncToGenerator3.default)( /*#__PURE__*/_regenerator2.default.mark(function _callee(docked) {
        ...
        return _regenerator2.default.wrap(function _callee$(_context) {
          while (1) {
            switch (_context.prev = _context.next) {
              case 0:
                id = PhysicsExtension.ExtensionId;
          ...
          while (1) {
            switch (_context2.prev = _context2.next) {
              ...
              case 2:
                ...
                _context2.next = 5;
                return physicsCore.loadPhysicModel(this.viewer.model);

              case 5:

                physicsCore.on('simulation.step', this.onSimulationStep);
    ...
    value: function onModelRootLoaded(event) {
      ...
      (0, _get3.default)(PhysicsExtension.prototype.__proto__ || (0, _getPrototypeOf2.default)(PhysicsExtension.prototype), 'onModelRootLoaded', this).call(this);
    ...
    value: function () {
      var _ref3 = (0, _asyncToGenerator3.default)( /*#__PURE__*/_regenerator2.default.mark(function _callee3(event) {
        var transformerReactOptions, transformerOptions, modelTransformer;
        return _regenerator2.default.wrap(function _callee3$(_context3) {
          while (1) {
            switch (_context3.prev = _context3.next) {
              case 0:
                transformerReactOptions = {
                ...
                transformerOptions = (0, _assign2.default)({}, {
                  react: transformerReactOptions,
                  fullTransform: false,
                  hideControls: true
                });
                _context3.next = 4;
                return this.viewer.loadDynamicExtension('Viewing.Extension.ModelTransformer', transformerOptions);

              case 4:
                modelTransformer = _context3.sent;


                modelTransformer.setModel(this.viewer.model);

                _context3.next = 8;
                return _Viewer4.default.getWorldBoundingBox(this.viewer.model);

              case 8:
                this.bounds = _context3.sent;
      ...
      function onModelCompletedLoad(_x2) {
        return _ref3.apply(this, arguments);
      }

      return onModelCompletedLoad;
    }()
    ...
    value: function onExtensionLoaded(event) {
      ...
      var transformExtensionId = 'Viewing.Extension.Transform';

      if (event.extensionId === transformExtensionId) {

        var transform = this.viewer.getExtension(transformExtensionId);

        transform.on('selection', this.onTransformSelection);

        transform.on('transform', this.onTransform);
    ...
    value: function onTransformSelection() {
      var _react$getState = this.react.getState(),
          physicsCore = _react$getState.physicsCore,
          selectedBody = _react$getState.selectedBody,
          unSelectedBody = _react$getState.unSelectedBody;

      if (selectedBody) {

        physicsCore.groundRigidBody(selectedBody, true);
      ...
      if (unSelectedBody) {
        ...
        physicsCore.groundRigidBody(unSelectedBody, false);
    ...
    key: 'onTransform',
    value: function onTransform(data) {
      var _react$getState2 = this.react.getState(),
          physicsCore = _react$getState2.physicsCore,
          selectedBody = _react$getState2.selectedBody;

      var transform = physicsCore.getFragmentTransform(data.fragIds[0]);

      physicsCore.setRigidBodyTransform(selectedBody, transform);
    ...
    key: 'setSelectedBody',
    value: function setSelectedBody(body) {
      var _react$getState3 = this.react.getState(),
          physicsCore = _react$getState3.physicsCore,
          selectedBody = _react$getState3.selectedBody;
      ...
      var velocity = physicsCore.getRigidBodyVelocity(body);
    ...
    value: function onSelection(event) {
      var _react$getState4 = this.react.getState(),
          physicsCore = _react$getState4.physicsCore;
      ...
      var body = physicsCore.getRigidBody(selection.dbIdArray[0]);
    ...
    key: 'onEnablePhysics',
    value: function onEnablePhysics(run) {
      var _react$getState5 = this.react.getState(),
          physicsCore = _react$getState5.physicsCore;
    ...
    value: function onReset() {
      var _react$getState6 = this.react.getState(),
          physicsCore = _react$getState6.physicsCore,
          selectedBody = _react$getState6.selectedBody;

      physicsCore.reset();

      this.setSelectedBody(selectedBody);
    ...
    value: function onSimulationStep() {
      var _react$getState7 = this.react.getState(),
          modelTransformer = _react$getState7.modelTransformer,
          selectedBody = _react$getState7.selectedBody;

      if (selectedBody) {

        this.setSelectedBody(selectedBody);

        var transform = modelTransformer.getFragmentTransform(selectedBody.initialState.fragIds[0]);
    ...
    key: 'onGravitySliderChanged',
    value: function onGravitySliderChanged(props) {
      var value = props.value,
          dragging = props.dragging,
          offset = props.offset;

      var _react$getState8 = this.react.getState(),
          physicsCore = _react$getState8.physicsCore;
    ...
    key: 'onTimeSkewSliderChanged',
    value: function onTimeSkewSliderChanged(props) {
      var value = props.value,
          dragging = props.dragging,
          offset = props.offset;

      var _react$getState9 = this.react.getState(),
          physicsCore = _react$getState9.physicsCore;
    ...
    key: 'setVelocityByKey',
    value: function setVelocityByKey(key, value, velocity) {
      ...
      switch (key) {
        ...
        case 'Ax':
          velocity.angular.x = this.toFloat(value) * Math.PI / 180;
          break;
        case 'Ay':
          velocity.angular.y = this.toFloat(value) * Math.PI / 180;
          break;
        case 'Az':
          velocity.angular.z = this.toFloat(value) * Math.PI / 180;
          break;
      }
    }
    ...
    value: function onInputChanged(e, key) {
      ...
      var velocity = state.physicsCore.getRigidBodyVelocity(state.selectedBody);

      this.setVelocityByKey(key, value, velocity);

      state.physicsCore.setRigidBodyVelocity(state.selectedBody, velocity);
    ...
    key: 'clearVelocity',
    value: function clearVelocity(keys) {
      var _this3 = this;
      ...
      keys.forEach(function (key) {
        ...
        state[key] = _this3.toFixedStr(0);

        _this3.setVelocityByKey(key, 0.0, velocity);
      });
    ...
    key: 'renderVelocity',
    value: function renderVelocity() {
      var _this5 = this;

      var state = this.react.getState();

      var disabled = !state.selectedBody;
      ...
      return _react2.default.createElement(
        ...
        _react2.default.createElement(
          'div',
          { className: 'row' },
          _react2.default.createElement(_Label2.default, { text: 'Angular:' }),
          _react2.default.createElement(_reactContenteditable2.default, {
            onChange: function onChange(e) {
              return _this5.onInputChanged(e, 'Ax');
            },
          ...
          _react2.default.createElement(_reactContenteditable2.default, {
            onChange: function onChange(e) {
              return _this5.onInputChanged(e, 'Ay');
            },
            onKeyDown: function onKeyDown(e) {
              return _this5.onKeyDownNumeric(e);
            },
          ...
          _react2.default.createElement(_reactContenteditable2.default, {
            onChange: function onChange(e) {
              return _this5.onInputChanged(e, 'Az');
            },
            onKeyDown: function onKeyDown(e) {
              return _this5.onKeyDownNumeric(e);
            },
          ...
          _react2.default.createElement(
            ...
            { className: state.rotate ? 'active' : '',
              onClick: function onClick() {
                return _this5.clearVelocity(['Ax', 'Ay', 'Az']);
              },
              disabled: disabled,
              title: 'Clear' },
        ...
        _react2.default.createElement(
          'div',
          { className: 'row' },
          _react2.default.createElement(_Label2.default, { text: 'Linear:' }),
          _react2.default.createElement(_reactContenteditable2.default, {
            onChange: function onChange(e) {
              return _this5.onInputChanged(e, 'Vx');
            },
            onKeyDown: function onKeyDown(e) {
              return _this5.onKeyDownNumeric(e);
            },
          ...
          _react2.default.createElement(_reactContenteditable2.default, {
            onChange: function onChange(e) {
              return _this5.onInputChanged(e, 'Vy');
            },
            onKeyDown: function onKeyDown(e) {
              return _this5.onKeyDownNumeric(e);
            },
          ...
          _react2.default.createElement(_reactContenteditable2.default, {
            onChange: function onChange(e) {
              return _this5.onInputChanged(e, 'Vz');
            },
            onKeyDown: function onKeyDown(e) {
              return _this5.onKeyDownNumeric(e);
            },
          ...
          _react2.default.createElement(
            ...
            { className: state.translate ? 'active' : '',
              onClick: function onClick() {
                return _this5.clearVelocity(['Vx', 'Vy', 'Vz']);
              },
              disabled: disabled,
              title: 'Clear' },
            _react2.default.createElement('span', { className: 'fa fa-times' })
    ...
    value: function renderControls() {
      ...
      var _react$getState10 = this.react.getState(),
          activateControls = _react$getState10.activateControls,
          physicsCore = _react$getState10.physicsCore,
          showLoader = _react$getState10.showLoader;
        ...
        physicsCore && _react2.default.createElement(
          ...
          _react2.default.createElement(
            ...
            _react2.default.createElement(_rcSlider2.default, {
              handle: function handle(props) {
                return _this6.onGravitySliderChanged(props);
              },
          ...
          _react2.default.createElement(
            ...
            _react2.default.createElement(
              ...
              'Time Skew: ',
              _react2.default.createElement('br', null),
              ' (Runs simulation slower > faster)'
            ),
            _react2.default.createElement(_rcSlider2.default, {
              handle: function handle(props) {
                return _this6.onTimeSkewSliderChanged(props);
              },
          ...
          _react2.default.createElement(
            'div',
            { className: 'control-element', style: { height: '120px' } },
            _react2.default.createElement(
              'label',
              null,
              'Component transform:'
    ...
    value: function renderTransformer() {
      var _react$getState11 = this.react.getState(),
          modelTransformer = _react$getState11.modelTransformer;

      return modelTransformer ? modelTransformer.render({ showTitle: false }) : false;
    }
...
Autodesk.Viewing.theExtensionManager.registerExtension(PhysicsExtension.ExtensionId, PhysicsExtension);

/* REACT HOT LOADER */ }).call(this); } finally { if (true) { (function () { var foundReactClasses = module.hot.data && module.hot.data.foundReactClasses || false; if (module.exports && module.makeHot) { var makeExportsHot = __webpack_require__(13); if (makeExportsHot(module, __webpack_require__(0))) { foundReactClasses = true; } var shouldAcceptModule = true && foundReactClasses; if (shouldAcceptModule) { module.hot.accept(function (err) { if (err) { console.error("Cannot apply hot update to " + "Viewing.Extension.Physics.RigidBody.js" + ": " + err.message); } }); } } module.hot.dispose(function (data) { data.makeHot = module.makeHot; data.foundReactClasses = foundReactClasses; }); })(); } }
...
if(true) {
	// When the styles change, update the <style> tags
	if(!content.locals) {
		module.hot.accept(1402, function() {
			var newContent = __webpack_require__(1402);
			if(typeof newContent === 'string') newContent = [[module.i, newContent, '']];
			update(newContent);
		});
	}
