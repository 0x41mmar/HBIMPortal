<?php
$debug = false;
echo "<!-- WU-History.php Version 3.1 -->\r";
/*------------------------------------------------
//WU-History.php
...
$WunderWrong = true;
//
$timezone   = "Europe/London";                    // Change to your TZ.  Ken True has a list available at http://saratoga-weather.org/timezone.txt
$WUID       = "IENGLAND1383";                          // Your stations Wunderground ID
$units      = "M";                                  // Default units which are changeable at runtime.  "M" for Metric, "E" for English or "B" for Both
$birthday   = "20-07-2016";                         // Stations first day of operation format dd-mm-yyyy.  This will determine years on the date selector.
...
$LangFtext  = "";              // Anything you wish or "" for a plain bar
...
$skipTab    = true;                                // true if you wish to suppress the tabular data
//
...
?>
	<div class="taC tm10" style="position: relative">
	...
	<div style="background-color: white;height: 34px;position: absolute;bottom: 0px;/*!  */width: 100%;left: 0px;"></div>
	<div class="noGap">&nbsp;</div>
	</div>
