...
Autodesk.ADN.Viewing.Extension.Material = function (viewer, options) {
  ...
  _self.load = function () {
    ...
    var fun = function() {
      ...
      //_textures.push(addTexMaterial("./wood.jpg"));
      //_textures.push(addTexMaterial("./steel.jpg"));
      //_textures.push(addTexMaterial("./brick.jpg"));
      ...
      $('<div/>').
        attr('id', texture1).
        append('<a href=""><img width="30" height="30" src="./extensions/Autodesk.ADN.Viewing.Extension.Material/wood.jpg"/></a>').
        appendTo(viewer.container);
